...
`)+`
`+d);const A=P+p+o,L=P+d+l,X=Kc(r,r.VERTEX_SHADER,A),I=Kc(r,r.FRAGMENT_SHADER,L);r.attachShader(E,X),r.attachShader(E,I),t.index0AttributeName!==void 0?r.bindAttribLocation(E,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(E,0,"position"),r.linkProgram(E);function D(N){if(i.debug.checkShaderErrors){const K=r.getProgramInfoLog(E).trim(),q=r.getShaderInfoLog(X).trim(),ne=r.getShaderInfoLog(I).trim();let te=!0,Z=!0;if(r.getProgramParameter(E,r.LINK_STATUS)===!1)if(te=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,E,X,I);else{const ae=Zc(r,X,"vertex"),R=Zc(r,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(E,r.VALIDATE_STATUS)+`
...
}`;function Pv(i,e,t){let n=new Fu;const r=new mt,a=new mt,o=new zt,l=new Av({depthPacking:Ef}),c=new wv,h={},f=t.maxTextureSize,g={[hi]:nn,[nn]:hi,[Xn]:Xn},m=new di({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new mt},radius:{value:4}},vertexShader:Cv,fragmentShader:Rv}),v=m.clone();v.defines.HORIZONTAL_PASS=1;const M=new Zn;M.setAttribute("position",new xn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const E=new $n(M,m),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=uu;let d=this.type;this.render=function(I,D,G){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||I.length===0)return;const T=i.getRenderTarget(),b=i.getActiveCubeFace(),N=i.getActiveMipmapLevel(),K=i.state;K.setBlending(ci),K.buffers.color.setClear(1,1,1,1),K.buffers.depth.setTest(!0),K.setScissorTest(!1);const q=d!==Wn&&this.type===Wn,ne=d===Wn&&this.type!==Wn;for(let te=0,Z=I.length;te<Z;te++){const ae=I[te],R=ae.shadow;if(R===void 0){console.warn("THREE.WebGLShadowMap:",ae,"has no shadow.");continue}if(R.autoUpdate===!1&&R.needsUpdate===!1)continue;r.copy(R.mapSize);const Me=R.getFrameExtents();if(r.multiply(Me),a.copy(R.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(a.x=Math.floor(f/Me.x),r.x=a.x*Me.x,R.mapSize.x=a.x),r.y>f&&(a.y=Math.floor(f/Me.y),r.y=a.y*Me.y,R.mapSize.y=a.y)),R.map===null||q===!0||ne===!0){const Te=this.type!==Wn?{minFilter:vn,magFilter:vn}:{};R.map!==null&&R.map.dispose(),R.map=new Bi(r.x,r.y,Te),R.map.texture.name=ae.name+".shadowMap",R.camera.updateProjectionMatrix()}i.setRenderTarget(R.map),i.clear();const Ee=R.getViewportCount();for(let Te=0;Te<Ee;Te++){const He=R.getViewport(Te);o.set(a.x*He.x,a.y*He.y,a.x*He.z,a.y*He.w),K.viewport(o),R.updateMatrices(ae,Te),n=R.getFrustum(),L(D,G,R.camera,ae,this.type)}R.isPointLightShadow!==!0&&this.type===Wn&&P(R,G),R.needsUpdate=!1}d=this.type,p.needsUpdate=!1,i.setRenderTarget(T,b,N)};function P(I,D){const G=e.update(E);m.defines.VSM_SAMPLES!==I.blurSamples&&(m.defines.VSM_SAMPLES=I.blurSamples,v.defines.VSM_SAMPLES=I.blurSamples,m.needsUpdate=!0,v.needsUpdate=!0),I.mapPass===null&&(I.mapPass=new Bi(r.x,r.y)),m.uniforms.shadow_pass.value=I.map.texture,m.uniforms.resolution.value=I.mapSize,m.uniforms.radius.value=I.radius,i.setRenderTarget(I.mapPass),i.clear(),i.renderBufferDirect(D,null,G,m,E,null),v.uniforms.shadow_pass.value=I.mapPass.texture,v.uniforms.resolution.value=I.mapSize,v.uniforms.radius.value=I.radius,i.setRenderTarget(I.map),i.clear(),i.renderBufferDirect(D,null,G,v,E,null)}function A(I,D,G,T){let b=null;const N=G.isPointLight===!0?I.customDistanceMaterial:I.customDepthMaterial;if(N!==void 0)b=N;else if(b=G.isPointLight===!0?c:l,i.localClippingEnabled&&D.clipShadows===!0&&Array.isArray(D.clippingPlanes)&&D.clippingPlanes.length!==0||D.displacementMap&&D.displacementScale!==0||D.alphaMap&&D.alphaTest>0||D.map&&D.alphaTest>0){const K=b.uuid,q=D.uuid;let ne=h[K];ne===void 0&&(ne={},h[K]=ne);let te=ne[q];te===void 0&&(te=b.clone(),ne[q]=te,D.addEventListener("dispose",X)),b=te}if(b.visible=D.visible,b.wireframe=D.wireframe,T===Wn?b.side=D.shadowSide!==null?D.shadowSide:D.side:b.side=D.shadowSide!==null?D.shadowSide:g[D.side],b.alphaMap=D.alphaMap,b.alphaTest=D.alphaTest,b.map=D.map,b.clipShadows=D.clipShadows,b.clippingPlanes=D.clippingPlanes,b.clipIntersection=D.clipIntersection,b.displacementMap=D.displacementMap,b.displacementScale=D.displacementScale,b.displacementBias=D.displacementBias,b.wireframeLinewidth=D.wireframeLinewidth,b.linewidth=D.linewidth,G.isPointLight===!0&&b.isMeshDistanceMaterial===!0){const K=i.properties.get(b);K.light=G}return b}function L(I,D,G,T,b){if(I.visible===!1)return;if(I.layers.test(D.layers)&&(I.isMesh||I.isLine||I.isPoints)&&(I.castShadow||I.receiveShadow&&b===Wn)&&(!I.frustumCulled||n.intersectsObject(I))){I.modelViewMatrix.multiplyMatrices(G.matrixWorldInverse,I.matrixWorld);const q=e.update(I),ne=I.material;if(Array.isArray(ne)){const te=q.groups;for(let Z=0,ae=te.length;Z<ae;Z++){const R=te[Z],Me=ne[R.materialIndex];if(Me&&Me.visible){const Ee=A(I,Me,T,b);I.onBeforeShadow(i,I,D,G,q,Ee,R),i.renderBufferDirect(G,null,q,Ee,I,R),I.onAfterShadow(i,I,D,G,q,Ee,R)}}}else if(ne.visible){const te=A(I,ne,T,b);I.onBeforeShadow(i,I,D,G,q,te,null),i.renderBufferDirect(G,null,q,te,I,null),I.onAfterShadow(i,I,D,G,q,te,null)}}const K=I.children;for(let q=0,ne=K.length;q<ne;q++)L(K[q],D,G,T,b)}function X(I){I.target.removeEventListener("dispose",X);for(const G in h){const T=h[G],b=I.target.uuid;b in T&&(T[b].dispose(),delete T[b])}}}function Lv(i){function e(){let F=!1;const he=new zt;let Q=null;const ie=new zt(0,0,0,0);return{setMask:function(fe){Q!==fe&&!F&&(i.colorMask(fe,fe,fe,fe),Q=fe)},setLocked:function(fe){F=fe},setClear:function(fe,Ge,ot,Ct,Ut){Ut===!0&&(fe*=Ct,Ge*=Ct,ot*=Ct),he.set(fe,Ge,ot,Ct),ie.equals(he)===!1&&(i.clearColor(fe,Ge,ot,Ct),ie.copy(he))},reset:function(){F=!1,Q=null,ie.set(-1,0,0,0)}}}function t(){let F=!1,he=null,Q=null,ie=null;return{setTest:function(fe){fe?j(i.DEPTH_TEST):me(i.DEPTH_TEST)},setMask:function(fe){he!==fe&&!F&&(i.depthMask(fe),he=fe)},setFunc:function(fe){if(Q!==fe){switch(fe){case sf:i.depthFunc(i.NEVER);break;case af:i.depthFunc(i.ALWAYS);break;case of:i.depthFunc(i.LESS);break;case Gs:i.depthFunc(i.LEQUAL);break;case lf:i.depthFunc(i.EQUAL);break;case cf:i.depthFunc(i.GEQUAL);break;case uf:i.depthFunc(i.GREATER);break;case hf:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}Q=fe}},setLocked:function(fe){F=fe},setClear:function(fe){ie!==fe&&(i.clearDepth(fe),ie=fe)},reset:function(){F=!1,he=null,Q=null,ie=null}}}function n(){let F=!1,he=null,Q=null,ie=null,fe=null,Ge=null,ot=null,Ct=null,Ut=null;return{setTest:function(at){F||(at?j(i.STENCIL_TEST):me(i.STENCIL_TEST))},setMask:function(at){he!==at&&!F&&(i.stencilMask(at),he=at)},setFunc:function(at,$t,cn){(Q!==at||ie!==$t||fe!==cn)&&(i.stencilFunc(at,$t,cn),Q=at,ie=$t,fe=cn)},setOp:function(at,$t,cn){(Ge!==at||ot!==$t||Ct!==cn)&&(i.stencilOp(at,$t,cn),Ge=at,ot=$t,Ct=cn)},setLocked:function(at){F=at},setClear:function(at){Ut!==at&&(i.clearStencil(at),Ut=at)},reset:function(){F=!1,he=null,Q=null,ie=null,fe=null,Ge=null,ot=null,Ct=null,Ut=null}}}const r=new e,a=new t,o=new n,l=new WeakMap,c=new WeakMap;let h={},f={},g=new WeakMap,m=[],v=null,M=!1,E=null,p=null,d=null,P=null,A=null,L=null,X=null,I=new xt(0,0,0),D=0,G=!1,T=null,b=null,N=null,K=null,q=null;const ne=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let te=!1,Z=0;const ae=i.getParameter(i.VERSION);ae.indexOf("WebGL")!==-1?(Z=parseFloat(/^WebGL (\d)/.exec(ae)[1]),te=Z>=1):ae.indexOf("OpenGL ES")!==-1&&(Z=parseFloat(/^OpenGL ES (\d)/.exec(ae)[1]),te=Z>=2);let R=null,Me={};const Ee=i.getParameter(i.SCISSOR_BOX),Te=i.getParameter(i.VIEWPORT),He=new zt().fromArray(Ee),st=new zt().fromArray(Te);function $(F,he,Q,ie){const fe=new Uint8Array(4),Ge=i.createTexture();i.bindTexture(F,Ge),i.texParameteri(F,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(F,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let ot=0;ot<Q;ot++)F===i.TEXTURE_3D||F===i.TEXTURE_2D_ARRAY?i.texImage3D(he,0,i.RGBA,1,1,ie,0,i.RGBA,i.UNSIGNED_BYTE,fe):i.texImage2D(he+ot,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,fe);return Ge}const le={};le[i.TEXTURE_2D]=$(i.TEXTURE_2D,i.TEXTURE_2D,1),le[i.TEXTURE_CUBE_MAP]=$(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),le[i.TEXTURE_2D_ARRAY]=$(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),le[i.TEXTURE_3D]=$(i.TEXTURE_3D,i.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),j(i.DEPTH_TEST),a.setFunc(Gs),Ae(!1),ge(uc),j(i.CULL_FACE),be(ci);function j(F){h[F]!==!0&&(i.enable(F),h[F]=!0)}function me(F){h[F]!==!1&&(i.disable(F),h[F]=!1)}function Oe(F,he){return f[F]!==he?(i.bindFramebuffer(F,he),f[F]=he,F===i.DRAW_FRAMEBUFFER&&(f[i.FRAMEBUFFER]=he),F===i.FRAMEBUFFER&&(f[i.DRAW_FRAMEBUFFER]=he),!0):!1}function Ye(F,he){let Q=m,ie=!1;if(F){Q=g.get(he),Q===void 0&&(Q=[],g.set(he,Q));const fe=F.textures;if(Q.length!==fe.length||Q[0]!==i.COLOR_ATTACHMENT0){for(let Ge=0,ot=fe.length;Ge<ot;Ge++)Q[Ge]=i.COLOR_ATTACHMENT0+Ge;Q.length=fe.length,ie=!0}}else Q[0]!==i.BACK&&(Q[0]=i.BACK,ie=!0);ie&&i.drawBuffers(Q)}function Ve(F){return v!==F?(i.useProgram(F),v=F,!0):!1}const J={[Di]:i.FUNC_ADD,[Hd]:i.FUNC_SUBTRACT,[Vd]:i.FUNC_REVERSE_SUBTRACT};J[Gd]=i.MIN,J[Wd]=i.MAX;const w={[Xd]:i.ZERO,[qd]:i.ONE,[Yd]:i.SRC_COLOR,[io]:i.SRC_ALPHA,[Qd]:i.SRC_ALPHA_SATURATE,[Zd]:i.DST_COLOR,[jd]:i.DST_ALPHA,[$d]:i.ONE_MINUS_SRC_COLOR,[ro]:i.ONE_MINUS_SRC_ALPHA,[Jd]:i.ONE_MINUS_DST_COLOR,[Kd]:i.ONE_MINUS_DST_ALPHA,[ef]:i.CONSTANT_COLOR,[tf]:i.ONE_MINUS_CONSTANT_COLOR,[nf]:i.CONSTANT_ALPHA,[rf]:i.ONE_MINUS_CONSTANT_ALPHA};function be(F,he,Q,ie,fe,Ge,ot,Ct,Ut,at){if(F===ci){M===!0&&(me(i.BLEND),M=!1);return}if(M===!1&&(j(i.BLEND),M=!0),F!==kd){if(F!==E||at!==G){if((p!==Di||A!==Di)&&(i.blendEquation(i.FUNC_ADD),p=Di,A=Di),at)switch(F){case fr:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case hc:i.blendFunc(i.ONE,i.ONE);break;case dc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case fc:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}else switch(F){case fr:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case hc:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case dc:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case fc:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",F);break}d=null,P=null,L=null,X=null,I.set(0,0,0),D=0,E=F,G=at}return}fe=fe||he,Ge=Ge||Q,ot=ot||ie,(he!==p||fe!==A)&&(i.blendEquationSeparate(J[he],J[fe]),p=he,A=fe),(Q!==d||ie!==P||Ge!==L||ot!==X)&&(i.blendFuncSeparate(w[Q],w[ie],w[Ge],w[ot]),d=Q,P=ie,L=Ge,X=ot),(Ct.equals(I)===!1||Ut!==D)&&(i.blendColor(Ct.r,Ct.g,Ct.b,Ut),I.copy(Ct),D=Ut),E=F,G=!1}function Ie(F,he){F.side===Xn?me(i.CULL_FACE):j(i.CULL_FACE);let Q=F.side===nn;he&&(Q=!Q),Ae(Q),F.blending===fr&&F.transparent===!1?be(ci):be(F.blending,F.blendEquation,F.blendSrc,F.blendDst,F.blendEquationAlpha,F.blendSrcAlpha,F.blendDstAlpha,F.blendColor,F.blendAlpha,F.premultipliedAlpha),a.setFunc(F.depthFunc),a.setTest(F.depthTest),a.setMask(F.depthWrite),r.setMask(F.colorWrite);const ie=F.stencilWrite;o.setTest(ie),ie&&(o.setMask(F.stencilWriteMask),o.setFunc(F.stencilFunc,F.stencilRef,F.stencilFuncMask),o.setOp(F.stencilFail,F.stencilZFail,F.stencilZPass)),Fe(F.polygonOffset,F.polygonOffsetFactor,F.polygonOffsetUnits),F.alphaToCoverage===!0?j(i.SAMPLE_ALPHA_TO_COVERAGE):me(i.SAMPLE_ALPHA_TO_COVERAGE)}function Ae(F){T!==F&&(F?i.frontFace(i.CW):i.frontFace(i.CCW),T=F)}function ge(F){F!==Fd?(j(i.CULL_FACE),F!==b&&(F===uc?i.cullFace(i.BACK):F===Bd?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):me(i.CULL_FACE),b=F}function ct(F){F!==N&&(te&&i.lineWidth(F),N=F)}function Fe(F,he,Q){F?(j(i.POLYGON_OFFSET_FILL),(K!==he||q!==Q)&&(i.polygonOffset(he,Q),K=he,q=Q)):me(i.POLYGON_OFFSET_FILL)}function Ue(F){F?j(i.SCISSOR_TEST):me(i.SCISSOR_TEST)}function C(F){F===void 0&&(F=i.TEXTURE0+ne-1),R!==F&&(i.activeTexture(F),R=F)}function x(F,he,Q){Q===void 0&&(R===null?Q=i.TEXTURE0+ne-1:Q=R);let ie=Me[Q];ie===void 0&&(ie={type:void 0,texture:void 0},Me[Q]=ie),(ie.type!==F||ie.texture!==he)&&(R!==Q&&(i.activeTexture(Q),R=Q),i.bindTexture(F,he||le[F]),ie.type=F,ie.texture=he)}function H(){const F=Me[R];F!==void 0&&F.type!==void 0&&(i.bindTexture(F.type,null),F.type=void 0,F.texture=void 0)}function ee(){try{i.compressedTexImage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function oe(){try{i.compressedTexImage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function se(){try{i.texSubImage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function De(){try{i.texSubImage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function de(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function xe(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ke(){try{i.texStorage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ce(){try{i.texStorage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function ye(){try{i.texImage2D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function it(){try{i.texImage3D.apply(i,arguments)}catch(F){console.error("THREE.WebGLState:",F)}}function qe(F){He.equals(F)===!1&&(i.scissor(F.x,F.y,F.z,F.w),He.copy(F))}function Ce(F){st.equals(F)===!1&&(i.viewport(F.x,F.y,F.z,F.w),st.copy(F))}function je(F,he){let Q=c.get(he);Q===void 0&&(Q=new WeakMap,c.set(he,Q));let ie=Q.get(F);ie===void 0&&(ie=i.getUniformBlockIndex(he,F.name),Q.set(F,ie))}function Qe(F,he){const ie=c.get(he).get(F);l.get(he)!==ie&&(i.uniformBlockBinding(he,ie,F.__bindingPointIndex),l.set(he,ie))}function bt(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},R=null,Me={},f={},g=new WeakMap,m=[],v=null,M=!1,E=null,p=null,d=null,P=null,A=null,L=null,X=null,I=new xt(0,0,0),D=0,G=!1,T=null,b=null,N=null,K=null,q=null,He.set(0,0,i.canvas.width,i.canvas.height),st.set(0,0,i.canvas.width,i.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:j,disable:me,bindFramebuffer:Oe,drawBuffers:Ye,useProgram:Ve,setBlending:be,setMaterial:Ie,setFlipSided:Ae,setCullFace:ge,setLineWidth:ct,setPolygonOffset:Fe,setScissorTest:Ue,activeTexture:C,bindTexture:x,unbindTexture:H,compressedTexImage2D:ee,compressedTexImage3D:oe,texImage2D:ye,texImage3D:it,updateUBOMapping:je,uniformBlockBinding:Qe,texStorage2D:ke,texStorage3D:ce,texSubImage2D:se,texSubImage3D:De,compressedTexSubImage2D:de,compressedTexSubImage3D:xe,scissor:qe,viewport:Ce,reset:bt}}function su(i,e,t,n){const r=Dv(n);switch(t){case gu:return i*e;case vu:return i*e;case xu:return i*e*2;case Mu:return i*e/r.components*r.byteLength;case Go:return i*e/r.components*r.byteLength;case Su:return i*e*2/r.components*r.byteLength;case Wo:return i*e*2/r.components*r.byteLength;case _u:return i*e*3/r.components*r.byteLength;case wn:return i*e*4/r.components*r.byteLength;case Xo:return i*e*4/r.components*r.byteLength;case Os:case Fs:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case Bs:case zs:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case uo:case fo:return Math.max(i,16)*Math.max(e,8)/4;case co:case ho:return Math.max(i,8)*Math.max(e,8)/2;case po:case mo:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*8;case go:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case _o:return Math.floor((i+3)/4)*Math.floor((e+3)/4)*16;case vo:return Math.floor((i+4)/5)*Math.floor((e+3)/4)*16;case xo:return Math.floor((i+4)/5)*Math.floor((e+4)/5)*16;case Mo:return Math.floor((i+5)/6)*Math.floor((e+4)/5)*16;case So:return Math.floor((i+5)/6)*Math.floor((e+5)/6)*16;case yo:return Math.floor((i+7)/8)*Math.floor((e+4)/5)*16;case Eo:return Math.floor((i+7)/8)*Math.floor((e+5)/6)*16;case bo:return Math.floor((i+7)/8)*Math.floor((e+7)/8)*16;case To:return Math.floor((i+9)/10)*Math.floor((e+4)/5)*16;case Ao:return Math.floor((i+9)/10)*Math.floor((e+5)/6)*16;case wo:return Math.floor((i+9)/10)*Math.floor((e+7)/8)*16;case Co:return Math.floor((i+9)/10)*Math.floor((e+9)/10)*16;case Ro:return Math.floor((i+11)/12)*Math.floor((e+9)/10)*16;case Po:return Math.floor((i+11)/12)*Math.floor((e+11)/12)*16;case ks:case Lo:case Do:return Math.ceil(i/4)*Math.ceil(e/4)*16;case yu:case Io:return Math.ceil(i/4)*Math.ceil(e/4)*8;case Uo:case No:return Math.ceil(i/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function Dv(i){switch(i){case jn:case fu:return{byteLength:1,components:1};case Fr:case pu:case Hr:return{byteLength:2,components:1};case Ho:case Vo:return{byteLength:2,components:4};case Fi:case ko:case qn:return{byteLength:4,components:1};case mu:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${i}.`)}function Iv(i,e,t,n,r,a,o){const l=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new mt,f=new WeakMap;let g;const m=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function M(C,x){return v?new OffscreenCanvas(C,x):$s("canvas")}function E(C,x,H){let ee=1;const oe=Ue(C);if((oe.width>H||oe.height>H)&&(ee=H/Math.max(oe.width,oe.height)),ee<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const se=Math.floor(ee*oe.width),De=Math.floor(ee*oe.height);g===void 0&&(g=M(se,De));const de=x?M(se,De):g;return de.width=se,de.height=De,de.getContext("2d").drawImage(C,0,0,se,De),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+oe.width+"x"+oe.height+") to ("+se+"x"+De+")."),de}else return"data"in C&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+oe.width+"x"+oe.height+")."),C;return C}function p(C){return C.generateMipmaps&&C.minFilter!==vn&&C.minFilter!==An}function d(C){i.generateMipmap(C)}function P(C,x,H,ee,oe=!1){if(C!==null){if(i[C]!==void 0)return i[C];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let se=x;if(x===i.RED&&(H===i.FLOAT&&(se=i.R32F),H===i.HALF_FLOAT&&(se=i.R16F),H===i.UNSIGNED_BYTE&&(se=i.R8)),x===i.RED_INTEGER&&(H===i.UNSIGNED_BYTE&&(se=i.R8UI),H===i.UNSIGNED_SHORT&&(se=i.R16UI),H===i.UNSIGNED_INT&&(se=i.R32UI),H===i.BYTE&&(se=i.R8I),H===i.SHORT&&(se=i.R16I),H===i.INT&&(se=i.R32I)),x===i.RG&&(H===i.FLOAT&&(se=i.RG32F),H===i.HALF_FLOAT&&(se=i.RG16F),H===i.UNSIGNED_BYTE&&(se=i.RG8)),x===i.RG_INTEGER&&(H===i.UNSIGNED_BYTE&&(se=i.RG8UI),H===i.UNSIGNED_SHORT&&(se=i.RG16UI),H===i.UNSIGNED_INT&&(se=i.RG32UI),H===i.BYTE&&(se=i.RG8I),H===i.SHORT&&(se=i.RG16I),H===i.INT&&(se=i.RG32I)),x===i.RGB&&H===i.UNSIGNED_INT_5_9_9_9_REV&&(se=i.RGB9_E5),x===i.RGBA){const De=oe?Ws:vt.getTransfer(ee);H===i.FLOAT&&(se=i.RGBA32F),H===i.HALF_FLOAT&&(se=i.RGBA16F),H===i.UNSIGNED_BYTE&&(se=De===wt?i.SRGB8_ALPHA8:i.RGBA8),H===i.UNSIGNED_SHORT_4_4_4_4&&(se=i.RGBA4),H===i.UNSIGNED_SHORT_5_5_5_1&&(se=i.RGB5_A1)}return(se===i.R16F||se===i.R32F||se===i.RG16F||se===i.RG32F||se===i.RGBA16F||se===i.RGBA32F)&&e.get("EXT_color_buffer_float"),se}function A(C,x){let H;return C?x===null||x===Fi||x===vr?H=i.DEPTH24_STENCIL8:x===qn?H=i.DEPTH32F_STENCIL8:x===Fr&&(H=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):x===null||x===Fi||x===vr?H=i.DEPTH_COMPONENT24:x===qn?H=i.DEPTH_COMPONENT32F:x===Fr&&(H=i.DEPTH_COMPONENT16),H}function L(C,x){return p(C)===!0||C.isFramebufferTexture&&C.minFilter!==vn&&C.minFilter!==An?Math.log2(Math.max(x.width,x.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?x.mipmaps.length:1}function X(C){const x=C.target;x.removeEventListener("dispose",X),D(x),x.isVideoTexture&&f.delete(x)}function I(C){const x=C.target;x.removeEventListener("dispose",I),T(x)}function D(C){const x=n.get(C);if(x.__webglInit===void 0)return;const H=C.source,ee=m.get(H);if(ee){const oe=ee[x.__cacheKey];oe.usedTimes--,oe.usedTimes===0&&G(C),Object.keys(ee).length===0&&m.delete(H)}n.remove(C)}function G(C){const x=n.get(C);i.deleteTexture(x.__webglTexture);const H=C.source,ee=m.get(H);delete ee[x.__cacheKey],o.memory.textures--}function T(C){const x=n.get(C);if(C.depthTexture&&C.depthTexture.dispose(),C.isWebGLCubeRenderTarget)for(let ee=0;ee<6;ee++){if(Array.isArray(x.__webglFramebuffer[ee]))for(let oe=0;oe<x.__webglFramebuffer[ee].length;oe++)i.deleteFramebuffer(x.__webglFramebuffer[ee][oe]);else i.deleteFramebuffer(x.__webglFramebuffer[ee]);x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer[ee])}else{if(Array.isArray(x.__webglFramebuffer))for(let ee=0;ee<x.__webglFramebuffer.length;ee++)i.deleteFramebuffer(x.__webglFramebuffer[ee]);else i.deleteFramebuffer(x.__webglFramebuffer);if(x.__webglDepthbuffer&&i.deleteRenderbuffer(x.__webglDepthbuffer),x.__webglMultisampledFramebuffer&&i.deleteFramebuffer(x.__webglMultisampledFramebuffer),x.__webglColorRenderbuffer)for(let ee=0;ee<x.__webglColorRenderbuffer.length;ee++)x.__webglColorRenderbuffer[ee]&&i.deleteRenderbuffer(x.__webglColorRenderbuffer[ee]);x.__webglDepthRenderbuffer&&i.deleteRenderbuffer(x.__webglDepthRenderbuffer)}const H=C.textures;for(let ee=0,oe=H.length;ee<oe;ee++){const se=n.get(H[ee]);se.__webglTexture&&(i.deleteTexture(se.__webglTexture),o.memory.textures--),n.remove(H[ee])}n.remove(C)}let b=0;function N(){b=0}function K(){const C=b;return C>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+r.maxTextures),b+=1,C}function q(C){const x=[];return x.push(C.wrapS),x.push(C.wrapT),x.push(C.wrapR||0),x.push(C.magFilter),x.push(C.minFilter),x.push(C.anisotropy),x.push(C.internalFormat),x.push(C.format),x.push(C.type),x.push(C.generateMipmaps),x.push(C.premultiplyAlpha),x.push(C.flipY),x.push(C.unpackAlignment),x.push(C.colorSpace),x.join()}function ne(C,x){const H=n.get(C);if(C.isVideoTexture&&ct(C),C.isRenderTargetTexture===!1&&C.version>0&&H.__version!==C.version){const ee=C.image;if(ee===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(ee.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{st(H,C,x);return}}t.bindTexture(i.TEXTURE_2D,H.__webglTexture,i.TEXTURE0+x)}function te(C,x){const H=n.get(C);if(C.version>0&&H.__version!==C.version){st(H,C,x);return}t.bindTexture(i.TEXTURE_2D_ARRAY,H.__webglTexture,i.TEXTURE0+x)}function Z(C,x){const H=n.get(C);if(C.version>0&&H.__version!==C.version){st(H,C,x);return}t.bindTexture(i.TEXTURE_3D,H.__webglTexture,i.TEXTURE0+x)}function ae(C,x){const H=n.get(C);if(C.version>0&&H.__version!==C.version){$(H,C,x);return}t.bindTexture(i.TEXTURE_CUBE_MAP,H.__webglTexture,i.TEXTURE0+x)}const R={[oo]:i.REPEAT,[Ui]:i.CLAMP_TO_EDGE,[lo]:i.MIRRORED_REPEAT},Me={[vn]:i.NEAREST,[Sf]:i.NEAREST_MIPMAP_NEAREST,[hs]:i.NEAREST_MIPMAP_LINEAR,[An]:i.LINEAR,[Ra]:i.LINEAR_MIPMAP_NEAREST,[Ni]:i.LINEAR_MIPMAP_LINEAR},Ee={[Af]:i.NEVER,[Df]:i.ALWAYS,[wf]:i.LESS,[Eu]:i.LEQUAL,[Cf]:i.EQUAL,[Lf]:i.GEQUAL,[Rf]:i.GREATER,[Pf]:i.NOTEQUAL};function Te(C,x){if(x.type===qn&&e.has("OES_texture_float_linear")===!1&&(x.magFilter===An||x.magFilter===Ra||x.magFilter===hs||x.magFilter===Ni||x.minFilter===An||x.minFilter===Ra||x.minFilter===hs||x.minFilter===Ni)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(C,i.TEXTURE_WRAP_S,R[x.wrapS]),i.texParameteri(C,i.TEXTURE_WRAP_T,R[x.wrapT]),(C===i.TEXTURE_3D||C===i.TEXTURE_2D_ARRAY)&&i.texParameteri(C,i.TEXTURE_WRAP_R,R[x.wrapR]),i.texParameteri(C,i.TEXTURE_MAG_FILTER,Me[x.magFilter]),i.texParameteri(C,i.TEXTURE_MIN_FILTER,Me[x.minFilter]),x.compareFunction&&(i.texParameteri(C,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(C,i.TEXTURE_COMPARE_FUNC,Ee[x.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(x.magFilter===vn||x.minFilter!==hs&&x.minFilter!==Ni||x.type===qn&&e.has("OES_texture_float_linear")===!1)return;if(x.anisotropy>1||n.get(x).__currentAnisotropy){const H=e.get("EXT_texture_filter_anisotropic");i.texParameterf(C,H.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),n.get(x).__currentAnisotropy=x.anisotropy}}}function He(C,x){let H=!1;C.__webglInit===void 0&&(C.__webglInit=!0,x.addEventListener("dispose",X));const ee=x.source;let oe=m.get(ee);oe===void 0&&(oe={},m.set(ee,oe));const se=q(x);if(se!==C.__cacheKey){oe[se]===void 0&&(oe[se]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,H=!0),oe[se].usedTimes++;const De=oe[C.__cacheKey];De!==void 0&&(oe[C.__cacheKey].usedTimes--,De.usedTimes===0&&G(x)),C.__cacheKey=se,C.__webglTexture=oe[se].texture}return H}function st(C,x,H){let ee=i.TEXTURE_2D;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(ee=i.TEXTURE_2D_ARRAY),x.isData3DTexture&&(ee=i.TEXTURE_3D);const oe=He(C,x),se=x.source;t.bindTexture(ee,C.__webglTexture,i.TEXTURE0+H);const De=n.get(se);if(se.version!==De.__version||oe===!0){t.activeTexture(i.TEXTURE0+H);const de=vt.getPrimaries(vt.workingColorSpace),xe=x.colorSpace===li?null:vt.getPrimaries(x.colorSpace),ke=x.colorSpace===li||de===xe?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ke);let ce=E(x.image,!1,r.maxTextureSize);ce=Fe(x,ce);const ye=a.convert(x.format,x.colorSpace),it=a.convert(x.type);let qe=P(x.internalFormat,ye,it,x.colorSpace,x.isVideoTexture);Te(ee,x);let Ce;const je=x.mipmaps,Qe=x.isVideoTexture!==!0,bt=De.__version===void 0||oe===!0,F=se.dataReady,he=L(x,ce);if(x.isDepthTexture)qe=A(x.format===xr,x.type),bt&&(Qe?t.texStorage2D(i.TEXTURE_2D,1,qe,ce.width,ce.height):t.texImage2D(i.TEXTURE_2D,0,qe,ce.width,ce.height,0,ye,it,null));else if(x.isDataTexture)if(je.length>0){Qe&&bt&&t.texStorage2D(i.TEXTURE_2D,he,qe,je[0].width,je[0].height);for(let Q=0,ie=je.length;Q<ie;Q++)Ce=je[Q],Qe?F&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,Ce.width,Ce.height,ye,it,Ce.data):t.texImage2D(i.TEXTURE_2D,Q,qe,Ce.width,Ce.height,0,ye,it,Ce.data);x.generateMipmaps=!1}else Qe?(bt&&t.texStorage2D(i.TEXTURE_2D,he,qe,ce.width,ce.height),F&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ce.width,ce.height,ye,it,ce.data)):t.texImage2D(i.TEXTURE_2D,0,qe,ce.width,ce.height,0,ye,it,ce.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){Qe&&bt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,he,qe,je[0].width,je[0].height,ce.depth);for(let Q=0,ie=je.length;Q<ie;Q++)if(Ce=je[Q],x.format!==wn)if(ye!==null)if(Qe){if(F)if(x.layerUpdates.size>0){const fe=su(Ce.width,Ce.height,x.format,x.type);for(const Ge of x.layerUpdates){const ot=Ce.data.subarray(Ge*fe/Ce.data.BYTES_PER_ELEMENT,(Ge+1)*fe/Ce.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,Ge,Ce.width,Ce.height,1,ye,ot,0,0)}x.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,Ce.width,Ce.height,ce.depth,ye,Ce.data,0,0)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Q,qe,Ce.width,Ce.height,ce.depth,0,Ce.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Qe?F&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,Ce.width,Ce.height,ce.depth,ye,it,Ce.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Q,qe,Ce.width,Ce.height,ce.depth,0,ye,it,Ce.data)}else{Qe&&bt&&t.texStorage2D(i.TEXTURE_2D,he,qe,je[0].width,je[0].height);for(let Q=0,ie=je.length;Q<ie;Q++)Ce=je[Q],x.format!==wn?ye!==null?Qe?F&&t.compressedTexSubImage2D(i.TEXTURE_2D,Q,0,0,Ce.width,Ce.height,ye,Ce.data):t.compressedTexImage2D(i.TEXTURE_2D,Q,qe,Ce.width,Ce.height,0,Ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Qe?F&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,Ce.width,Ce.height,ye,it,Ce.data):t.texImage2D(i.TEXTURE_2D,Q,qe,Ce.width,Ce.height,0,ye,it,Ce.data)}else if(x.isDataArrayTexture)if(Qe){if(bt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,he,qe,ce.width,ce.height,ce.depth),F)if(x.layerUpdates.size>0){const Q=su(ce.width,ce.height,x.format,x.type);for(const ie of x.layerUpdates){const fe=ce.data.subarray(ie*Q/ce.data.BYTES_PER_ELEMENT,(ie+1)*Q/ce.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,ie,ce.width,ce.height,1,ye,it,fe)}x.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ce.width,ce.height,ce.depth,ye,it,ce.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,qe,ce.width,ce.height,ce.depth,0,ye,it,ce.data);else if(x.isData3DTexture)Qe?(bt&&t.texStorage3D(i.TEXTURE_3D,he,qe,ce.width,ce.height,ce.depth),F&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ce.width,ce.height,ce.depth,ye,it,ce.data)):t.texImage3D(i.TEXTURE_3D,0,qe,ce.width,ce.height,ce.depth,0,ye,it,ce.data);else if(x.isFramebufferTexture){if(bt)if(Qe)t.texStorage2D(i.TEXTURE_2D,he,qe,ce.width,ce.height);else{let Q=ce.width,ie=ce.height;for(let fe=0;fe<he;fe++)t.texImage2D(i.TEXTURE_2D,fe,qe,Q,ie,0,ye,it,null),Q>>=1,ie>>=1}}else if(je.length>0){if(Qe&&bt){const Q=Ue(je[0]);t.texStorage2D(i.TEXTURE_2D,he,qe,Q.width,Q.height)}for(let Q=0,ie=je.length;Q<ie;Q++)Ce=je[Q],Qe?F&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,ye,it,Ce):t.texImage2D(i.TEXTURE_2D,Q,qe,ye,it,Ce);x.generateMipmaps=!1}else if(Qe){if(bt){const Q=Ue(ce);t.texStorage2D(i.TEXTURE_2D,he,qe,Q.width,Q.height)}F&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ye,it,ce)}else t.texImage2D(i.TEXTURE_2D,0,qe,ye,it,ce);p(x)&&d(ee),De.__version=se.version,x.onUpdate&&x.onUpdate(x)}C.__version=x.version}function $(C,x,H){if(x.image.length!==6)return;const ee=He(C,x),oe=x.source;t.bindTexture(i.TEXTURE_CUBE_MAP,C.__webglTexture,i.TEXTURE0+H);const se=n.get(oe);if(oe.version!==se.__version||ee===!0){t.activeTexture(i.TEXTURE0+H);const De=vt.getPrimaries(vt.workingColorSpace),de=x.colorSpace===li?null:vt.getPrimaries(x.colorSpace),xe=x.colorSpace===li||De===de?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,x.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,x.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,x.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,xe);const ke=x.isCompressedTexture||x.image[0].isCompressedTexture,ce=x.image[0]&&x.image[0].isDataTexture,ye=[];for(let ie=0;ie<6;ie++)!ke&&!ce?ye[ie]=E(x.image[ie],!0,r.maxCubemapSize):ye[ie]=ce?x.image[ie].image:x.image[ie],ye[ie]=Fe(x,ye[ie]);const it=ye[0],qe=a.convert(x.format,x.colorSpace),Ce=a.convert(x.type),je=P(x.internalFormat,qe,Ce,x.colorSpace),Qe=x.isVideoTexture!==!0,bt=se.__version===void 0||ee===!0,F=oe.dataReady;let he=L(x,it);Te(i.TEXTURE_CUBE_MAP,x);let Q;if(ke){Qe&&bt&&t.texStorage2D(i.TEXTURE_CUBE_MAP,he,je,it.width,it.height);for(let ie=0;ie<6;ie++){Q=ye[ie].mipmaps;for(let fe=0;fe<Q.length;fe++){const Ge=Q[fe];x.format!==wn?qe!==null?Qe?F&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,fe,0,0,Ge.width,Ge.height,qe,Ge.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,fe,je,Ge.width,Ge.height,0,Ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Qe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,fe,0,0,Ge.width,Ge.height,qe,Ce,Ge.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,fe,je,Ge.width,Ge.height,0,qe,Ce,Ge.data)}}}else{if(Q=x.mipmaps,Qe&&bt){Q.length>0&&he++;const ie=Ue(ye[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,he,je,ie.width,ie.height)}for(let ie=0;ie<6;ie++)if(ce){Qe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,0,0,ye[ie].width,ye[ie].height,qe,Ce,ye[ie].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,je,ye[ie].width,ye[ie].height,0,qe,Ce,ye[ie].data);for(let fe=0;fe<Q.length;fe++){const ot=Q[fe].image[ie].image;Qe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,fe+1,0,0,ot.width,ot.height,qe,Ce,ot.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,fe+1,je,ot.width,ot.height,0,qe,Ce,ot.data)}}else{Qe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,0,0,qe,Ce,ye[ie]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,je,qe,Ce,ye[ie]);for(let fe=0;fe<Q.length;fe++){const Ge=Q[fe];Qe?F&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,fe+1,0,0,qe,Ce,Ge.image[ie]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,fe+1,je,qe,Ce,Ge.image[ie])}}}p(x)&&d(i.TEXTURE_CUBE_MAP),se.__version=oe.version,x.onUpdate&&x.onUpdate(x)}C.__version=x.version}function le(C,x,H,ee,oe,se){const De=a.convert(H.format,H.colorSpace),de=a.convert(H.type),xe=P(H.internalFormat,De,de,H.colorSpace);if(!n.get(x).__hasExternalTextures){const ce=Math.max(1,x.width>>se),ye=Math.max(1,x.height>>se);oe===i.TEXTURE_3D||oe===i.TEXTURE_2D_ARRAY?t.texImage3D(oe,se,xe,ce,ye,x.depth,0,De,de,null):t.texImage2D(oe,se,xe,ce,ye,0,De,de,null)}t.bindFramebuffer(i.FRAMEBUFFER,C),ge(x)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,ee,oe,n.get(H).__webglTexture,0,Ae(x)):(oe===i.TEXTURE_2D||oe>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&oe<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,ee,oe,n.get(H).__webglTexture,se),t.bindFramebuffer(i.FRAMEBUFFER,null)}function j(C,x,H){if(i.bindRenderbuffer(i.RENDERBUFFER,C),x.depthBuffer){const ee=x.depthTexture,oe=ee&&ee.isDepthTexture?ee.type:null,se=A(x.stencilBuffer,oe),De=x.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,de=Ae(x);ge(x)?l.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,de,se,x.width,x.height):H?i.renderbufferStorageMultisample(i.RENDERBUFFER,de,se,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,se,x.width,x.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,De,i.RENDERBUFFER,C)}else{const ee=x.textures;for(let oe=0;oe<ee.length;oe++){const se=ee[oe],De=a.convert(se.format,se.colorSpace),de=a.convert(se.type),xe=P(se.internalFormat,De,de,se.colorSpace),ke=Ae(x);H&&ge(x)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,ke,xe,x.width,x.height):ge(x)?l.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ke,xe,x.width,x.height):i.renderbufferStorage(i.RENDERBUFFER,xe,x.width,x.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function me(C,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,C),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),ne(x.depthTexture,0);const ee=n.get(x.depthTexture).__webglTexture,oe=Ae(x);if(x.depthTexture.format===pr)ge(x)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ee,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ee,0);else if(x.depthTexture.format===xr)ge(x)?l.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ee,0,oe):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ee,0);else throw new Error("Unknown depthTexture format")}function Oe(C){const x=n.get(C),H=C.isWebGLCubeRenderTarget===!0;if(C.depthTexture&&!x.__autoAllocateDepthBuffer){if(H)throw new Error("target.depthTexture not supported in Cube render targets");me(x.__webglFramebuffer,C)}else if(H){x.__webglDepthbuffer=[];for(let ee=0;ee<6;ee++)t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer[ee]),x.__webglDepthbuffer[ee]=i.createRenderbuffer(),j(x.__webglDepthbuffer[ee],C,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,x.__webglFramebuffer),x.__webglDepthbuffer=i.createRenderbuffer(),j(x.__webglDepthbuffer,C,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ye(C,x,H){const ee=n.get(C);x!==void 0&&le(ee.__webglFramebuffer,C,C.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),H!==void 0&&Oe(C)}function Ve(C){const x=C.texture,H=n.get(C),ee=n.get(x);C.addEventListener("dispose",I);const oe=C.textures,se=C.isWebGLCubeRenderTarget===!0,De=oe.length>1;if(De||(ee.__webglTexture===void 0&&(ee.__webglTexture=i.createTexture()),ee.__version=x.version,o.memory.textures++),se){H.__webglFramebuffer=[];for(let de=0;de<6;de++)if(x.mipmaps&&x.mipmaps.length>0){H.__webglFramebuffer[de]=[];for(let xe=0;xe<x.mipmaps.length;xe++)H.__webglFramebuffer[de][xe]=i.createFramebuffer()}else H.__webglFramebuffer[de]=i.createFramebuffer()}else{if(x.mipmaps&&x.mipmaps.length>0){H.__webglFramebuffer=[];for(let de=0;de<x.mipmaps.length;de++)H.__webglFramebuffer[de]=i.createFramebuffer()}else H.__webglFramebuffer=i.createFramebuffer();if(De)for(let de=0,xe=oe.length;de<xe;de++){const ke=n.get(oe[de]);ke.__webglTexture===void 0&&(ke.__webglTexture=i.createTexture(),o.memory.textures++)}if(C.samples>0&&ge(C)===!1){H.__webglMultisampledFramebuffer=i.createFramebuffer(),H.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,H.__webglMultisampledFramebuffer);for(let de=0;de<oe.length;de++){const xe=oe[de];H.__webglColorRenderbuffer[de]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,H.__webglColorRenderbuffer[de]);const ke=a.convert(xe.format,xe.colorSpace),ce=a.convert(xe.type),ye=P(xe.internalFormat,ke,ce,xe.colorSpace,C.isXRRenderTarget===!0),it=Ae(C);i.renderbufferStorageMultisample(i.RENDERBUFFER,it,ye,C.width,C.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+de,i.RENDERBUFFER,H.__webglColorRenderbuffer[de])}i.bindRenderbuffer(i.RENDERBUFFER,null),C.depthBuffer&&(H.__webglDepthRenderbuffer=i.createRenderbuffer(),j(H.__webglDepthRenderbuffer,C,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(se){t.bindTexture(i.TEXTURE_CUBE_MAP,ee.__webglTexture),Te(i.TEXTURE_CUBE_MAP,x);for(let de=0;de<6;de++)if(x.mipmaps&&x.mipmaps.length>0)for(let xe=0;xe<x.mipmaps.length;xe++)le(H.__webglFramebuffer[de][xe],C,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+de,xe);else le(H.__webglFramebuffer[de],C,x,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+de,0);p(x)&&d(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(De){for(let de=0,xe=oe.length;de<xe;de++){const ke=oe[de],ce=n.get(ke);t.bindTexture(i.TEXTURE_2D,ce.__webglTexture),Te(i.TEXTURE_2D,ke),le(H.__webglFramebuffer,C,ke,i.COLOR_ATTACHMENT0+de,i.TEXTURE_2D,0),p(ke)&&d(i.TEXTURE_2D)}t.unbindTexture()}else{let de=i.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(de=C.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(de,ee.__webglTexture),Te(de,x),x.mipmaps&&x.mipmaps.length>0)for(let xe=0;xe<x.mipmaps.length;xe++)le(H.__webglFramebuffer[xe],C,x,i.COLOR_ATTACHMENT0,de,xe);else le(H.__webglFramebuffer,C,x,i.COLOR_ATTACHMENT0,de,0);p(x)&&d(de),t.unbindTexture()}C.depthBuffer&&Oe(C)}function J(C){const x=C.textures;for(let H=0,ee=x.length;H<ee;H++){const oe=x[H];if(p(oe)){const se=C.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,De=n.get(oe).__webglTexture;t.bindTexture(se,De),d(se),t.unbindTexture()}}}const w=[],be=[];function Ie(C){if(C.samples>0){if(ge(C)===!1){const x=C.textures,H=C.width,ee=C.height;let oe=i.COLOR_BUFFER_BIT;const se=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,De=n.get(C),de=x.length>1;if(de)for(let xe=0;xe<x.length;xe++)t.bindFramebuffer(i.FRAMEBUFFER,De.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,De.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,De.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,De.__webglFramebuffer);for(let xe=0;xe<x.length;xe++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(oe|=i.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(oe|=i.STENCIL_BUFFER_BIT)),de){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,De.__webglColorRenderbuffer[xe]);const ke=n.get(x[xe]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ke,0)}i.blitFramebuffer(0,0,H,ee,0,0,H,ee,oe,i.NEAREST),c===!0&&(w.length=0,be.length=0,w.push(i.COLOR_ATTACHMENT0+xe),C.depthBuffer&&C.resolveDepthBuffer===!1&&(w.push(se),be.push(se),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,be)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,w))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),de)for(let xe=0;xe<x.length;xe++){t.bindFramebuffer(i.FRAMEBUFFER,De.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.RENDERBUFFER,De.__webglColorRenderbuffer[xe]);const ke=n.get(x[xe]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,De.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+xe,i.TEXTURE_2D,ke,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,De.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&c){const x=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[x])}}}function Ae(C){return Math.min(r.maxSamples,C.samples)}function ge(C){const x=n.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function ct(C){const x=o.render.frame;f.get(C)!==x&&(f.set(C,x),C.update())}function Fe(C,x){const H=C.colorSpace,ee=C.format,oe=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||H!==fi&&H!==li&&(vt.getTransfer(H)===wt?(ee!==wn||oe!==jn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",H)),x}function Ue(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(h.width=C.naturalWidth||C.width,h.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(h.width=C.displayWidth,h.height=C.displayHeight):(h.width=C.width,h.height=C.height),h}this.allocateTextureUnit=K,this.resetTextureUnits=N,this.setTexture2D=ne,this.setTexture2DArray=te,this.setTexture3D=Z,this.setTextureCube=ae,this.rebindTextures=Ye,this.setupRenderTarget=Ve,this.updateRenderTargetMipmap=J,this.updateMultisampleRenderTarget=Ie,this.setupDepthRenderbuffer=Oe,this.setupFrameBufferTexture=le,this.useMultisampledRTT=ge}function Uv(i,e){function t(n,r=li){let a;const o=vt.getTransfer(r);if(n===jn)return i.UNSIGNED_BYTE;if(n===Ho)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Vo)return i.UNSIGNED_SHORT_5_5_5_1;if(n===mu)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===fu)return i.BYTE;if(n===pu)return i.SHORT;if(n===Fr)return i.UNSIGNED_SHORT;if(n===ko)return i.INT;if(n===Fi)return i.UNSIGNED_INT;if(n===qn)return i.FLOAT;if(n===Hr)return i.HALF_FLOAT;if(n===gu)return i.ALPHA;if(n===_u)return i.RGB;if(n===wn)return i.RGBA;if(n===vu)return i.LUMINANCE;if(n===xu)return i.LUMINANCE_ALPHA;if(n===pr)return i.DEPTH_COMPONENT;if(n===xr)return i.DEPTH_STENCIL;if(n===Mu)return i.RED;if(n===Go)return i.RED_INTEGER;if(n===Su)return i.RG;if(n===Wo)return i.RG_INTEGER;if(n===Xo)return i.RGBA_INTEGER;if(n===Os||n===Fs||n===Bs||n===zs)if(o===wt)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(n===Os)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Fs)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Bs)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===zs)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(n===Os)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Fs)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Bs)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===zs)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===co||n===uo||n===ho||n===fo)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(n===co)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===uo)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===ho)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===fo)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===po||n===mo||n===go)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(n===po||n===mo)return o===wt?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(n===go)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===_o||n===vo||n===xo||n===Mo||n===So||n===yo||n===Eo||n===bo||n===To||n===Ao||n===wo||n===Co||n===Ro||n===Po)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(n===_o)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===vo)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===xo)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Mo)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===So)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===yo)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Eo)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===bo)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===To)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Ao)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===wo)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Co)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ro)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Po)return o===wt?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===ks||n===Lo||n===Do)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(n===ks)return o===wt?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Lo)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Do)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===yu||n===Io||n===Uo||n===No)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(n===ks)return a.COMPRESSED_RED_RGTC1_EXT;if(n===Io)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Uo)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===No)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===vr?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class Nv extends gn{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Is extends sn{constructor(){super(),this.isGroup=!0,this.type="Group"}}const Ov={type:"move"};class no{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Is,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Is,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new W,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new W),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Is,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new W,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new W),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let r=null,a=null,o=null;const l=this._targetRay,c=this._grip,h=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(h&&e.hand){o=!0;for(const E of e.hand.values()){const p=t.getJointPose(E,n),d=this._getHandJoint(h,E);p!==null&&(d.matrix.fromArray(p.transform.matrix),d.matrix.decompose(d.position,d.rotation,d.scale),d.matrixWorldNeedsUpdate=!0,d.jointRadius=p.radius),d.visible=p!==null}const f=h.joints["index-finger-tip"],g=h.joints["thumb-tip"],m=f.position.distanceTo(g.position),v=.02,M=.005;h.inputState.pinching&&m>v+M?(h.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!h.inputState.pinching&&m<=v-M&&(h.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else c!==null&&e.gripSpace&&(a=t.getPose(e.gripSpace,n),a!==null&&(c.matrix.fromArray(a.transform.matrix),c.matrix.decompose(c.position,c.rotation,c.scale),c.matrixWorldNeedsUpdate=!0,a.linearVelocity?(c.hasLinearVelocity=!0,c.linearVelocity.copy(a.linearVelocity)):c.hasLinearVelocity=!1,a.angularVelocity?(c.hasAngularVelocity=!0,c.angularVelocity.copy(a.angularVelocity)):c.hasAngularVelocity=!1));l!==null&&(r=t.getPose(e.targetRaySpace,n),r===null&&a!==null&&(r=a),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1,this.dispatchEvent(Ov)))}return l!==null&&(l.visible=r!==null),c!==null&&(c.visible=a!==null),h!==null&&(h.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Is;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const Fv=`
void main() {
...
}`;class zv{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,n){if(this.texture===null){const r=new rn,a=e.properties.get(r);a.__webglTexture=t.texture,(t.depthNear!=n.depthNear||t.depthFar!=n.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new di({vertexShader:Fv,fragmentShader:Bv,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new $n(new ea(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class kv extends Sr{constructor(e,t){super();const n=this;let r=null,a=1,o=null,l="local-floor",c=1,h=null,f=null,g=null,m=null,v=null,M=null;const E=new zv,p=t.getContextAttributes();let d=null,P=null;const A=[],L=[],X=new mt;let I=null;const D=new gn;D.layers.enable(1),D.viewport=new zt;const G=new gn;G.layers.enable(2),G.viewport=new zt;const T=[D,G],b=new Nv;b.layers.enable(1),b.layers.enable(2);let N=null,K=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let le=A[$];return le===void 0&&(le=new no,A[$]=le),le.getTargetRaySpace()},this.getControllerGrip=function($){let le=A[$];return le===void 0&&(le=new no,A[$]=le),le.getGripSpace()},this.getHand=function($){let le=A[$];return le===void 0&&(le=new no,A[$]=le),le.getHandSpace()};function q($){const le=L.indexOf($.inputSource);if(le===-1)return;const j=A[le];j!==void 0&&(j.update($.inputSource,$.frame,h||o),j.dispatchEvent({type:$.type,data:$.inputSource}))}function ne(){r.removeEventListener("select",q),r.removeEventListener("selectstart",q),r.removeEventListener("selectend",q),r.removeEventListener("squeeze",q),r.removeEventListener("squeezestart",q),r.removeEventListener("squeezeend",q),r.removeEventListener("end",ne),r.removeEventListener("inputsourceschange",te);for(let $=0;$<A.length;$++){const le=L[$];le!==null&&(L[$]=null,A[$].disconnect(le))}N=null,K=null,E.reset(),e.setRenderTarget(d),v=null,m=null,g=null,r=null,P=null,st.stop(),n.isPresenting=!1,e.setPixelRatio(I),e.setSize(X.width,X.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){a=$,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){l=$,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return h||o},this.setReferenceSpace=function($){h=$},this.getBaseLayer=function(){return m!==null?m:v},this.getBinding=function(){return g},this.getFrame=function(){return M},this.getSession=function(){return r},this.setSession=async function($){if(r=$,r!==null){if(d=e.getRenderTarget(),r.addEventListener("select",q),r.addEventListener("selectstart",q),r.addEventListener("selectend",q),r.addEventListener("squeeze",q),r.addEventListener("squeezestart",q),r.addEventListener("squeezeend",q),r.addEventListener("end",ne),r.addEventListener("inputsourceschange",te),p.xrCompatible!==!0&&await t.makeXRCompatible(),I=e.getPixelRatio(),e.getSize(X),r.renderState.layers===void 0){const le={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:a};v=new XRWebGLLayer(r,t,le),r.updateRenderState({baseLayer:v}),e.setPixelRatio(1),e.setSize(v.framebufferWidth,v.framebufferHeight,!1),P=new Bi(v.framebufferWidth,v.framebufferHeight,{format:wn,type:jn,colorSpace:e.outputColorSpace,stencilBuffer:p.stencil})}else{let le=null,j=null,me=null;p.depth&&(me=p.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,le=p.stencil?xr:pr,j=p.stencil?vr:Fi);const Oe={colorFormat:t.RGBA8,depthFormat:me,scaleFactor:a};g=new XRWebGLBinding(r,t),m=g.createProjectionLayer(Oe),r.updateRenderState({layers:[m]}),e.setPixelRatio(1),e.setSize(m.textureWidth,m.textureHeight,!1),P=new Bi(m.textureWidth,m.textureHeight,{format:wn,type:jn,depthTexture:new zu(m.textureWidth,m.textureHeight,j,void 0,void 0,void 0,void 0,void 0,void 0,le),stencilBuffer:p.stencil,colorSpace:e.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:m.ignoreDepthValues===!1})}P.isXRRenderTarget=!0,this.setFoveation(c),h=null,o=await r.requestReferenceSpace(l),st.setContext(r),st.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return E.getDepthTexture()};function te($){for(let le=0;le<$.removed.length;le++){const j=$.removed[le],me=L.indexOf(j);me>=0&&(L[me]=null,A[me].disconnect(j))}for(let le=0;le<$.added.length;le++){const j=$.added[le];let me=L.indexOf(j);if(me===-1){for(let Ye=0;Ye<A.length;Ye++)if(Ye>=L.length){L.push(j),me=Ye;break}else if(L[Ye]===null){L[Ye]=j,me=Ye;break}if(me===-1)break}const Oe=A[me];Oe&&Oe.connect(j)}}const Z=new W,ae=new W;function R($,le,j){Z.setFromMatrixPosition(le.matrixWorld),ae.setFromMatrixPosition(j.matrixWorld);const me=Z.distanceTo(ae),Oe=le.projectionMatrix.elements,Ye=j.projectionMatrix.elements,Ve=Oe[14]/(Oe[10]-1),J=Oe[14]/(Oe[10]+1),w=(Oe[9]+1)/Oe[5],be=(Oe[9]-1)/Oe[5],Ie=(Oe[8]-1)/Oe[0],Ae=(Ye[8]+1)/Ye[0],ge=Ve*Ie,ct=Ve*Ae,Fe=me/(-Ie+Ae),Ue=Fe*-Ie;le.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(Ue),$.translateZ(Fe),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert();const C=Ve+Fe,x=J+Fe,H=ge-Ue,ee=ct+(me-Ue),oe=w*J/x*C,se=be*J/x*C;$.projectionMatrix.makePerspective(H,ee,oe,se,C,x),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}function Me($,le){le===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(le.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(r===null)return;E.texture!==null&&($.near=E.depthNear,$.far=E.depthFar),b.near=G.near=D.near=$.near,b.far=G.far=D.far=$.far,(N!==b.near||K!==b.far)&&(r.updateRenderState({depthNear:b.near,depthFar:b.far}),N=b.near,K=b.far,D.near=N,D.far=K,G.near=N,G.far=K,D.updateProjectionMatrix(),G.updateProjectionMatrix(),$.updateProjectionMatrix());const le=$.parent,j=b.cameras;Me(b,le);for(let me=0;me<j.length;me++)Me(j[me],le);j.length===2?R(b,D,G):b.projectionMatrix.copy(D.projectionMatrix),Ee($,b,le)};function Ee($,le,j){j===null?$.matrix.copy(le.matrixWorld):($.matrix.copy(j.matrixWorld),$.matrix.invert(),$.matrix.multiply(le.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(le.projectionMatrix),$.projectionMatrixInverse.copy(le.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=Oo*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return b},this.getFoveation=function(){if(!(m===null&&v===null))return c},this.setFoveation=function($){c=$,m!==null&&(m.fixedFoveation=$),v!==null&&v.fixedFoveation!==void 0&&(v.fixedFoveation=$)},this.hasDepthSensing=function(){return E.texture!==null},this.getDepthSensingMesh=function(){return E.getMesh(b)};let Te=null;function He($,le){if(f=le.getViewerPose(h||o),M=le,f!==null){const j=f.views;v!==null&&(e.setRenderTargetFramebuffer(P,v.framebuffer),e.setRenderTarget(P));let me=!1;j.length!==b.cameras.length&&(b.cameras.length=0,me=!0);for(let Ye=0;Ye<j.length;Ye++){const Ve=j[Ye];let J=null;if(v!==null)J=v.getViewport(Ve);else{const be=g.getViewSubImage(m,Ve);J=be.viewport,Ye===0&&(e.setRenderTargetTextures(P,be.colorTexture,m.ignoreDepthValues?void 0:be.depthStencilTexture),e.setRenderTarget(P))}let w=T[Ye];w===void 0&&(w=new gn,w.layers.enable(Ye),w.viewport=new zt,T[Ye]=w),w.matrix.fromArray(Ve.transform.matrix),w.matrix.decompose(w.position,w.quaternion,w.scale),w.projectionMatrix.fromArray(Ve.projectionMatrix),w.projectionMatrixInverse.copy(w.projectionMatrix).invert(),w.viewport.set(J.x,J.y,J.width,J.height),Ye===0&&(b.matrix.copy(w.matrix),b.matrix.decompose(b.position,b.quaternion,b.scale)),me===!0&&b.cameras.push(w)}const Oe=r.enabledFeatures;if(Oe&&Oe.includes("depth-sensing")){const Ye=g.getDepthInformation(j[0]);Ye&&Ye.isValid&&Ye.texture&&E.init(e,Ye,r.renderState)}}for(let j=0;j<A.length;j++){const me=L[j],Oe=A[j];me!==null&&Oe!==void 0&&Oe.update(me,le,h||o)}Te&&Te($,le),le.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:le}),M=null}const st=new Bu;st.setAnimationLoop(He),this.setAnimationLoop=function($){Te=$},this.dispose=function(){}}}const Ri=new Kn,Hv=new It;function Vv(i,e){function t(p,d){p.matrixAutoUpdate===!0&&p.updateMatrix(),d.value.copy(p.matrix)}function n(p,d){d.color.getRGB(p.fogColor.value,Uu(i)),d.isFog?(p.fogNear.value=d.near,p.fogFar.value=d.far):d.isFogExp2&&(p.fogDensity.value=d.density)}function r(p,d,P,A,L){d.isMeshBasicMaterial||d.isMeshLambertMaterial?a(p,d):d.isMeshToonMaterial?(a(p,d),g(p,d)):d.isMeshPhongMaterial?(a(p,d),f(p,d)):d.isMeshStandardMaterial?(a(p,d),m(p,d),d.isMeshPhysicalMaterial&&v(p,d,L)):d.isMeshMatcapMaterial?(a(p,d),M(p,d)):d.isMeshDepthMaterial?a(p,d):d.isMeshDistanceMaterial?(a(p,d),E(p,d)):d.isMeshNormalMaterial?a(p,d):d.isLineBasicMaterial?(o(p,d),d.isLineDashedMaterial&&l(p,d)):d.isPointsMaterial?c(p,d,P,A):d.isSpriteMaterial?h(p,d):d.isShadowMaterial?(p.color.value.copy(d.color),p.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function a(p,d){p.opacity.value=d.opacity,d.color&&p.diffuse.value.copy(d.color),d.emissive&&p.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(p.map.value=d.map,t(d.map,p.mapTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.bumpMap&&(p.bumpMap.value=d.bumpMap,t(d.bumpMap,p.bumpMapTransform),p.bumpScale.value=d.bumpScale,d.side===nn&&(p.bumpScale.value*=-1)),d.normalMap&&(p.normalMap.value=d.normalMap,t(d.normalMap,p.normalMapTransform),p.normalScale.value.copy(d.normalScale),d.side===nn&&p.normalScale.value.negate()),d.displacementMap&&(p.displacementMap.value=d.displacementMap,t(d.displacementMap,p.displacementMapTransform),p.displacementScale.value=d.displacementScale,p.displacementBias.value=d.displacementBias),d.emissiveMap&&(p.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,p.emissiveMapTransform)),d.specularMap&&(p.specularMap.value=d.specularMap,t(d.specularMap,p.specularMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest);const P=e.get(d),A=P.envMap,L=P.envMapRotation;A&&(p.envMap.value=A,Ri.copy(L),Ri.x*=-1,Ri.y*=-1,Ri.z*=-1,A.isCubeTexture&&A.isRenderTargetTexture===!1&&(Ri.y*=-1,Ri.z*=-1),p.envMapRotation.value.setFromMatrix4(Hv.makeRotationFromEuler(Ri)),p.flipEnvMap.value=A.isCubeTexture&&A.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=d.reflectivity,p.ior.value=d.ior,p.refractionRatio.value=d.refractionRatio),d.lightMap&&(p.lightMap.value=d.lightMap,p.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,p.lightMapTransform)),d.aoMap&&(p.aoMap.value=d.aoMap,p.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,p.aoMapTransform))}function o(p,d){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,d.map&&(p.map.value=d.map,t(d.map,p.mapTransform))}function l(p,d){p.dashSize.value=d.dashSize,p.totalSize.value=d.dashSize+d.gapSize,p.scale.value=d.scale}function c(p,d,P,A){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,p.size.value=d.size*P,p.scale.value=A*.5,d.map&&(p.map.value=d.map,t(d.map,p.uvTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest)}function h(p,d){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,p.rotation.value=d.rotation,d.map&&(p.map.value=d.map,t(d.map,p.mapTransform)),d.alphaMap&&(p.alphaMap.value=d.alphaMap,t(d.alphaMap,p.alphaMapTransform)),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest)}function f(p,d){p.specular.value.copy(d.specular),p.shininess.value=Math.max(d.shininess,1e-4)}function g(p,d){d.gradientMap&&(p.gradientMap.value=d.gradientMap)}function m(p,d){p.metalness.value=d.metalness,d.metalnessMap&&(p.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,p.metalnessMapTransform)),p.roughness.value=d.roughness,d.roughnessMap&&(p.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,p.roughnessMapTransform)),d.envMap&&(p.envMapIntensity.value=d.envMapIntensity)}function v(p,d,P){p.ior.value=d.ior,d.sheen>0&&(p.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),p.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(p.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,p.sheenColorMapTransform)),d.sheenRoughnessMap&&(p.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,p.sheenRoughnessMapTransform))),d.clearcoat>0&&(p.clearcoat.value=d.clearcoat,p.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(p.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,p.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(p.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===nn&&p.clearcoatNormalScale.value.negate())),d.dispersion>0&&(p.dispersion.value=d.dispersion),d.iridescence>0&&(p.iridescence.value=d.iridescence,p.iridescenceIOR.value=d.iridescenceIOR,p.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(p.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,p.iridescenceMapTransform)),d.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),d.transmission>0&&(p.transmission.value=d.transmission,p.transmissionSamplerMap.value=P.texture,p.transmissionSamplerSize.value.set(P.width,P.height),d.transmissionMap&&(p.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,p.transmissionMapTransform)),p.thickness.value=d.thickness,d.thicknessMap&&(p.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=d.attenuationDistance,p.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(p.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(p.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=d.specularIntensity,p.specularColor.value.copy(d.specularColor),d.specularColorMap&&(p.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,p.specularColorMapTransform)),d.specularIntensityMap&&(p.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,p.specularIntensityMapTransform))}function M(p,d){d.matcap&&(p.matcap.value=d.matcap)}function E(p,d){const P=e.get(d).light;p.referencePosition.value.setFromMatrixPosition(P.matrixWorld),p.nearDistance.value=P.shadow.camera.near,p.farDistance.value=P.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Gv(i,e,t,n){let r={},a={},o=[];const l=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(P,A){const L=A.program;n.uniformBlockBinding(P,L)}function h(P,A){let L=r[P.id];L===void 0&&(M(P),L=f(P),r[P.id]=L,P.addEventListener("dispose",p));const X=A.program;n.updateUBOMapping(P,X);const I=e.render.frame;a[P.id]!==I&&(m(P),a[P.id]=I)}function f(P){const A=g();P.__bindingPointIndex=A;const L=i.createBuffer(),X=P.__size,I=P.usage;return i.bindBuffer(i.UNIFORM_BUFFER,L),i.bufferData(i.UNIFORM_BUFFER,X,I),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,A,L),L}function g(){for(let P=0;P<l;P++)if(o.indexOf(P)===-1)return o.push(P),P;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function m(P){const A=r[P.id],L=P.uniforms,X=P.__cache;i.bindBuffer(i.UNIFORM_BUFFER,A);for(let I=0,D=L.length;I<D;I++){const G=Array.isArray(L[I])?L[I]:[L[I]];for(let T=0,b=G.length;T<b;T++){const N=G[T];if(v(N,I,T,X)===!0){const K=N.__offset,q=Array.isArray(N.value)?N.value:[N.value];let ne=0;for(let te=0;te<q.length;te++){const Z=q[te],ae=E(Z);typeof Z=="number"||typeof Z=="boolean"?(N.__data[0]=Z,i.bufferSubData(i.UNIFORM_BUFFER,K+ne,N.__data)):Z.isMatrix3?(N.__data[0]=Z.elements[0],N.__data[1]=Z.elements[1],N.__data[2]=Z.elements[2],N.__data[3]=0,N.__data[4]=Z.elements[3],N.__data[5]=Z.elements[4],N.__data[6]=Z.elements[5],N.__data[7]=0,N.__data[8]=Z.elements[6],N.__data[9]=Z.elements[7],N.__data[10]=Z.elements[8],N.__data[11]=0):(Z.toArray(N.__data,ne),ne+=ae.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,K,N.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function v(P,A,L,X){const I=P.value,D=A+"_"+L;if(X[D]===void 0)return typeof I=="number"||typeof I=="boolean"?X[D]=I:X[D]=I.clone(),!0;{const G=X[D];if(typeof I=="number"||typeof I=="boolean"){if(G!==I)return X[D]=I,!0}else if(G.equals(I)===!1)return G.copy(I),!0}return!1}function M(P){const A=P.uniforms;let L=0;const X=16;for(let D=0,G=A.length;D<G;D++){const T=Array.isArray(A[D])?A[D]:[A[D]];for(let b=0,N=T.length;b<N;b++){const K=T[b],q=Array.isArray(K.value)?K.value:[K.value];for(let ne=0,te=q.length;ne<te;ne++){const Z=q[ne],ae=E(Z),R=L%X;R!==0&&X-R<ae.boundary&&(L+=X-R),K.__data=new Float32Array(ae.storage/Float32Array.BYTES_PER_ELEMENT),K.__offset=L,L+=ae.storage}}}const I=L%X;return I>0&&(L+=X-I),P.__size=L,P.__cache={},this}function E(P){const A={boundary:0,storage:0};return typeof P=="number"||typeof P=="boolean"?(A.boundary=4,A.storage=4):P.isVector2?(A.boundary=8,A.storage=8):P.isVector3||P.isColor?(A.boundary=16,A.storage=12):P.isVector4?(A.boundary=16,A.storage=16):P.isMatrix3?(A.boundary=48,A.storage=48):P.isMatrix4?(A.boundary=64,A.storage=64):P.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",P),A}function p(P){const A=P.target;A.removeEventListener("dispose",p);const L=o.indexOf(A.__bindingPointIndex);o.splice(L,1),i.deleteBuffer(r[A.id]),delete r[A.id],delete a[A.id]}function d(){for(const P in r)i.deleteBuffer(r[P]);o=[],r={},a={}}return{bind:c,update:h,dispose:d}}class Wv{constructor(e={}){const{canvas:t=Uf(),context:n=null,depth:r=!0,stencil:a=!1,alpha:o=!1,antialias:l=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:h=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:g=!1}=e;this.isWebGLRenderer=!0;let m;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");m=n.getContextAttributes().alpha}else m=o;const v=new Uint32Array(4),M=new Int32Array(4);let E=null,p=null;const d=[],P=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=Ln,this.toneMapping=ui,this.toneMappingExposure=1;const A=this;let L=!1,X=0,I=0,D=null,G=-1,T=null;const b=new zt,N=new zt;let K=null;const q=new xt(0);let ne=0,te=t.width,Z=t.height,ae=1,R=null,Me=null;const Ee=new zt(0,0,te,Z),Te=new zt(0,0,te,Z);let He=!1;const st=new Fu;let $=!1,le=!1;const j=new It,me=new W,Oe=new zt,Ye={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ve=!1;function J(){return D===null?ae:1}let w=n;function be(S,U){return t.getContext(S,U)}try{const S={alpha:!0,depth:r,stencil:a,antialias:l,premultipliedAlpha:c,preserveDrawingBuffer:h,powerPreference:f,failIfMajorPerformanceCaveat:g};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${zo}`),t.addEventListener("webglcontextlost",Q,!1),t.addEventListener("webglcontextrestored",ie,!1),t.addEventListener("webglcontextcreationerror",fe,!1),w===null){const U="webgl2";if(w=be(U,S),w===null)throw be(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let Ie,Ae,ge,ct,Fe,Ue,C,x,H,ee,oe,se,De,de,xe,ke,ce,ye,it,qe,Ce,je,Qe,bt;function F(){Ie=new Zg(w),Ie.init(),je=new Uv(w,Ie),Ae=new Wg(w,Ie,e,je),ge=new Lv(w),ct=new e_(w),Fe=new _v,Ue=new Iv(w,Ie,ge,Fe,Ae,je,ct),C=new qg(A),x=new Kg(A),H=new ap(w),Qe=new Vg(w,H),ee=new Jg(w,H,ct,Qe),oe=new n_(w,ee,H,ct),it=new t_(w,Ae,Ue),ke=new Xg(Fe),se=new gv(A,C,x,Ie,Ae,Qe,ke),De=new Vv(A,Fe),de=new xv,xe=new Tv(Ie),ye=new Hg(A,C,x,ge,oe,m,c),ce=new Pv(A,oe,Ae),bt=new Gv(w,ct,Ae,ge),qe=new Gg(w,Ie,ct),Ce=new Qg(w,Ie,ct),ct.programs=se.programs,A.capabilities=Ae,A.extensions=Ie,A.properties=Fe,A.renderLists=de,A.shadowMap=ce,A.state=ge,A.info=ct}F();const he=new kv(A,w);this.xr=he,this.getContext=function(){return w},this.getContextAttributes=function(){return w.getContextAttributes()},this.forceContextLoss=function(){const S=Ie.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=Ie.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return ae},this.setPixelRatio=function(S){S!==void 0&&(ae=S,this.setSize(te,Z,!1))},this.getSize=function(S){return S.set(te,Z)},this.setSize=function(S,U,k=!0){if(he.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}te=S,Z=U,t.width=Math.floor(S*ae),t.height=Math.floor(U*ae),k===!0&&(t.style.width=S+"px",t.style.height=U+"px"),this.setViewport(0,0,S,U)},this.getDrawingBufferSize=function(S){return S.set(te*ae,Z*ae).floor()},this.setDrawingBufferSize=function(S,U,k){te=S,Z=U,ae=k,t.width=Math.floor(S*k),t.height=Math.floor(U*k),this.setViewport(0,0,S,U)},this.getCurrentViewport=function(S){return S.copy(b)},this.getViewport=function(S){return S.copy(Ee)},this.setViewport=function(S,U,k,V){S.isVector4?Ee.set(S.x,S.y,S.z,S.w):Ee.set(S,U,k,V),ge.viewport(b.copy(Ee).multiplyScalar(ae).round())},this.getScissor=function(S){return S.copy(Te)},this.setScissor=function(S,U,k,V){S.isVector4?Te.set(S.x,S.y,S.z,S.w):Te.set(S,U,k,V),ge.scissor(N.copy(Te).multiplyScalar(ae).round())},this.getScissorTest=function(){return He},this.setScissorTest=function(S){ge.setScissorTest(He=S)},this.setOpaqueSort=function(S){R=S},this.setTransparentSort=function(S){Me=S},this.getClearColor=function(S){return S.copy(ye.getClearColor())},this.setClearColor=function(){ye.setClearColor.apply(ye,arguments)},this.getClearAlpha=function(){return ye.getClearAlpha()},this.setClearAlpha=function(){ye.setClearAlpha.apply(ye,arguments)},this.clear=function(S=!0,U=!0,k=!0){let V=0;if(S){let z=!1;if(D!==null){const ue=D.texture.format;z=ue===Xo||ue===Wo||ue===Go}if(z){const ue=D.texture.type,_e=ue===jn||ue===Fi||ue===Fr||ue===vr||ue===Ho||ue===Vo,Pe=ye.getClearColor(),Le=ye.getClearAlpha(),Be=Pe.r,We=Pe.g,ze=Pe.b;_e?(v[0]=Be,v[1]=We,v[2]=ze,v[3]=Le,w.clearBufferuiv(w.COLOR,0,v)):(M[0]=Be,M[1]=We,M[2]=ze,M[3]=Le,w.clearBufferiv(w.COLOR,0,M))}else V|=w.COLOR_BUFFER_BIT}U&&(V|=w.DEPTH_BUFFER_BIT),k&&(V|=w.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),w.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",Q,!1),t.removeEventListener("webglcontextrestored",ie,!1),t.removeEventListener("webglcontextcreationerror",fe,!1),de.dispose(),xe.dispose(),Fe.dispose(),C.dispose(),x.dispose(),oe.dispose(),Qe.dispose(),bt.dispose(),se.dispose(),he.dispose(),he.removeEventListener("sessionstart",cn),he.removeEventListener("sessionend",Yr),Un.stop()};function Q(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),L=!0}function ie(){console.log("THREE.WebGLRenderer: Context Restored."),L=!1;const S=ct.autoReset,U=ce.enabled,k=ce.autoUpdate,V=ce.needsUpdate,z=ce.type;F(),ct.autoReset=S,ce.enabled=U,ce.autoUpdate=k,ce.needsUpdate=V,ce.type=z}function fe(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function Ge(S){const U=S.target;U.removeEventListener("dispose",Ge),ot(U)}function ot(S){Ct(S),Fe.remove(S)}function Ct(S){const U=Fe.get(S).programs;U!==void 0&&(U.forEach(function(k){se.releaseProgram(k)}),S.isShaderMaterial&&se.releaseShaderCache(S))}this.renderBufferDirect=function(S,U,k,V,z,ue){U===null&&(U=Ye);const _e=z.isMesh&&z.matrixWorld.determinant()<0,Pe=ia(S,U,k,V,z);ge.setMaterial(V,_e);let Le=k.index,Be=1;if(V.wireframe===!0){if(Le=ee.getWireframeAttribute(k),Le===void 0)return;Be=2}const We=k.drawRange,ze=k.attributes.position;let ut=We.start*Be,Tt=(We.start+We.count)*Be;ue!==null&&(ut=Math.max(ut,ue.start*Be),Tt=Math.min(Tt,(ue.start+ue.count)*Be)),Le!==null?(ut=Math.max(ut,0),Tt=Math.min(Tt,Le.count)):ze!=null&&(ut=Math.max(ut,0),Tt=Math.min(Tt,ze.count));const At=Tt-ut;if(At<0||At===1/0)return;Qe.setup(z,V,Pe,k,Le);let Ht,dt=qe;if(Le!==null&&(Ht=H.get(Le),dt=Ce,dt.setIndex(Ht)),z.isMesh)V.wireframe===!0?(ge.setLineWidth(V.wireframeLinewidth*J()),dt.setMode(w.LINES)):dt.setMode(w.TRIANGLES);else if(z.isLine){let Ne=V.linewidth;Ne===void 0&&(Ne=1),ge.setLineWidth(Ne*J()),z.isLineSegments?dt.setMode(w.LINES):z.isLineLoop?dt.setMode(w.LINE_LOOP):dt.setMode(w.LINE_STRIP)}else z.isPoints?dt.setMode(w.POINTS):z.isSprite&&dt.setMode(w.TRIANGLES);if(z.isBatchedMesh)if(z._multiDrawInstances!==null)dt.renderMultiDrawInstances(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount,z._multiDrawInstances);else if(Ie.get("WEBGL_multi_draw"))dt.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{const Ne=z._multiDrawStarts,Lt=z._multiDrawCounts,ft=z._multiDrawCount,Jt=Le?H.get(Le).bytesPerElement:1,Nn=Fe.get(V).currentProgram.getUniforms();for(let Vt=0;Vt<ft;Vt++)Nn.setValue(w,"_gl_DrawID",Vt),dt.render(Ne[Vt]/Jt,Lt[Vt])}else if(z.isInstancedMesh)dt.renderInstances(ut,At,z.count);else if(k.isInstancedBufferGeometry){const Ne=k._maxInstanceCount!==void 0?k._maxInstanceCount:1/0,Lt=Math.min(k.instanceCount,Ne);dt.renderInstances(ut,At,Lt)}else dt.render(ut,At)};function Ut(S,U,k){S.transparent===!0&&S.side===Xn&&S.forceSinglePass===!1?(S.side=nn,S.needsUpdate=!0,ki(S,U,k),S.side=hi,S.needsUpdate=!0,ki(S,U,k),S.side=Xn):ki(S,U,k)}this.compile=function(S,U,k=null){k===null&&(k=S),p=xe.get(k),p.init(U),P.push(p),k.traverseVisible(function(z){z.isLight&&z.layers.test(U.layers)&&(p.pushLight(z),z.castShadow&&p.pushShadow(z))}),S!==k&&S.traverseVisible(function(z){z.isLight&&z.layers.test(U.layers)&&(p.pushLight(z),z.castShadow&&p.pushShadow(z))}),p.setupLights();const V=new Set;return S.traverse(function(z){const ue=z.material;if(ue)if(Array.isArray(ue))for(let _e=0;_e<ue.length;_e++){const Pe=ue[_e];Ut(Pe,k,z),V.add(Pe)}else Ut(ue,k,z),V.add(ue)}),P.pop(),p=null,V},this.compileAsync=function(S,U,k=null){const V=this.compile(S,U,k);return new Promise(z=>{function ue(){if(V.forEach(function(_e){Fe.get(_e).currentProgram.isReady()&&V.delete(_e)}),V.size===0){z(S);return}setTimeout(ue,10)}Ie.get("KHR_parallel_shader_compile")!==null?ue():setTimeout(ue,10)})};let at=null;function $t(S){at&&at(S)}function cn(){Un.stop()}function Yr(){Un.start()}const Un=new Bu;Un.setAnimationLoop($t),typeof self<"u"&&Un.setContext(self),this.setAnimationLoop=function(S){at=S,he.setAnimationLoop(S),S===null?Un.stop():Un.start()},he.addEventListener("sessionstart",cn),he.addEventListener("sessionend",Yr),this.render=function(S,U){if(U!==void 0&&U.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(L===!0)return;if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),he.enabled===!0&&he.isPresenting===!0&&(he.cameraAutoUpdate===!0&&he.updateCamera(U),U=he.getCamera()),S.isScene===!0&&S.onBeforeRender(A,S,U,D),p=xe.get(S,P.length),p.init(U),P.push(p),j.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),st.setFromProjectionMatrix(j),le=this.localClippingEnabled,$=ke.init(this.clippingPlanes,le),E=de.get(S,d.length),E.init(),d.push(E),he.enabled===!0&&he.isPresenting===!0){const ue=A.xr.getDepthSensingMesh();ue!==null&&Er(ue,U,-1/0,A.sortObjects)}Er(S,U,0,A.sortObjects),E.finish(),A.sortObjects===!0&&E.sort(R,Me),Ve=he.enabled===!1||he.isPresenting===!1||he.hasDepthSensing()===!1,Ve&&ye.addToRenderList(E,S),this.info.render.frame++,$===!0&&ke.beginShadows();const k=p.state.shadowsArray;ce.render(k,S,U),$===!0&&ke.endShadows(),this.info.autoReset===!0&&this.info.reset();const V=E.opaque,z=E.transmissive;if(p.setupLights(),U.isArrayCamera){const ue=U.cameras;if(z.length>0)for(let _e=0,Pe=ue.length;_e<Pe;_e++){const Le=ue[_e];zi(V,z,S,Le)}Ve&&ye.render(S);for(let _e=0,Pe=ue.length;_e<Pe;_e++){const Le=ue[_e];$r(E,S,Le,Le.viewport)}}else z.length>0&&zi(V,z,S,U),Ve&&ye.render(S),$r(E,S,U);D!==null&&(Ue.updateMultisampleRenderTarget(D),Ue.updateRenderTargetMipmap(D)),S.isScene===!0&&S.onAfterRender(A,S,U),Qe.resetDefaultState(),G=-1,T=null,P.pop(),P.length>0?(p=P[P.length-1],$===!0&&ke.setGlobalState(A.clippingPlanes,p.state.camera)):p=null,d.pop(),d.length>0?E=d[d.length-1]:E=null};function Er(S,U,k,V){if(S.visible===!1)return;if(S.layers.test(U.layers)){if(S.isGroup)k=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(U);else if(S.isLight)p.pushLight(S),S.castShadow&&p.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||st.intersectsSprite(S)){V&&Oe.setFromMatrixPosition(S.matrixWorld).applyMatrix4(j);const _e=oe.update(S),Pe=S.material;Pe.visible&&E.push(S,_e,Pe,k,Oe.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||st.intersectsObject(S))){const _e=oe.update(S),Pe=S.material;if(V&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),Oe.copy(S.boundingSphere.center)):(_e.boundingSphere===null&&_e.computeBoundingSphere(),Oe.copy(_e.boundingSphere.center)),Oe.applyMatrix4(S.matrixWorld).applyMatrix4(j)),Array.isArray(Pe)){const Le=_e.groups;for(let Be=0,We=Le.length;Be<We;Be++){const ze=Le[Be],ut=Pe[ze.materialIndex];ut&&ut.visible&&E.push(S,_e,ut,k,Oe.z,ze)}}else Pe.visible&&E.push(S,_e,Pe,k,Oe.z,null)}}const ue=S.children;for(let _e=0,Pe=ue.length;_e<Pe;_e++)Er(ue[_e],U,k,V)}function $r(S,U,k,V){const z=S.opaque,ue=S.transmissive,_e=S.transparent;p.setupLightsView(k),$===!0&&ke.setGlobalState(A.clippingPlanes,k),V&&ge.viewport(b.copy(V)),z.length>0&&Mn(z,U,k),ue.length>0&&Mn(ue,U,k),_e.length>0&&Mn(_e,U,k),ge.buffers.depth.setTest(!0),ge.buffers.depth.setMask(!0),ge.buffers.color.setMask(!0),ge.setPolygonOffset(!1)}function zi(S,U,k,V){if((k.isScene===!0?k.overrideMaterial:null)!==null)return;p.state.transmissionRenderTarget[V.id]===void 0&&(p.state.transmissionRenderTarget[V.id]=new Bi(1,1,{generateMipmaps:!0,type:Ie.has("EXT_color_buffer_half_float")||Ie.has("EXT_color_buffer_float")?Hr:jn,minFilter:Ni,samples:4,stencilBuffer:a,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:vt.workingColorSpace}));const ue=p.state.transmissionRenderTarget[V.id],_e=V.viewport||b;ue.setSize(_e.z,_e.w);const Pe=A.getRenderTarget();A.setRenderTarget(ue),A.getClearColor(q),ne=A.getClearAlpha(),ne<1&&A.setClearColor(16777215,.5),Ve?ye.render(k):A.clear();const Le=A.toneMapping;A.toneMapping=ui;const Be=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),p.setupLightsView(V),$===!0&&ke.setGlobalState(A.clippingPlanes,V),Mn(S,k,V),Ue.updateMultisampleRenderTarget(ue),Ue.updateRenderTargetMipmap(ue),Ie.has("WEBGL_multisampled_render_to_texture")===!1){let We=!1;for(let ze=0,ut=U.length;ze<ut;ze++){const Tt=U[ze],At=Tt.object,Ht=Tt.geometry,dt=Tt.material,Ne=Tt.group;if(dt.side===Xn&&At.layers.test(V.layers)){const Lt=dt.side;dt.side=nn,dt.needsUpdate=!0,pi(At,k,V,Ht,dt,Ne),dt.side=Lt,dt.needsUpdate=!0,We=!0}}We===!0&&(Ue.updateMultisampleRenderTarget(ue),Ue.updateRenderTargetMipmap(ue))}A.setRenderTarget(Pe),A.setClearColor(q,ne),Be!==void 0&&(V.viewport=Be),A.toneMapping=Le}function Mn(S,U,k){const V=U.isScene===!0?U.overrideMaterial:null;for(let z=0,ue=S.length;z<ue;z++){const _e=S[z],Pe=_e.object,Le=_e.geometry,Be=V===null?_e.material:V,We=_e.group;Pe.layers.test(k.layers)&&pi(Pe,U,k,Le,Be,We)}}function pi(S,U,k,V,z,ue){S.onBeforeRender(A,U,k,V,z,ue),S.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),z.transparent===!0&&z.side===Xn&&z.forceSinglePass===!1?(z.side=nn,z.needsUpdate=!0,A.renderBufferDirect(k,U,V,z,S,ue),z.side=hi,z.needsUpdate=!0,A.renderBufferDirect(k,U,V,z,S,ue),z.side=Xn):A.renderBufferDirect(k,U,V,z,S,ue),S.onAfterRender(A,U,k,V,z,ue)}function ki(S,U,k){U.isScene!==!0&&(U=Ye);const V=Fe.get(S),z=p.state.lights,ue=p.state.shadowsArray,_e=z.state.version,Pe=se.getParameters(S,z.state,ue,U,k),Le=se.getProgramCacheKey(Pe);let Be=V.programs;V.environment=S.isMeshStandardMaterial?U.environment:null,V.fog=U.fog,V.envMap=(S.isMeshStandardMaterial?x:C).get(S.envMap||V.environment),V.envMapRotation=V.environment!==null&&S.envMap===null?U.environmentRotation:S.envMapRotation,Be===void 0&&(S.addEventListener("dispose",Ge),Be=new Map,V.programs=Be);let We=Be.get(Le);if(We!==void 0){if(V.currentProgram===We&&V.lightsStateVersion===_e)return jr(S,Pe),We}else Pe.uniforms=se.getUniforms(S),S.onBeforeCompile(Pe,A),We=se.acquireProgram(Pe,Le),Be.set(Le,We),V.uniforms=Pe.uniforms;const ze=V.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(ze.clippingPlanes=ke.uniform),jr(S,Pe),V.needsLights=kt(S),V.lightsStateVersion=_e,V.needsLights&&(ze.ambientLightColor.value=z.state.ambient,ze.lightProbe.value=z.state.probe,ze.directionalLights.value=z.state.directional,ze.directionalLightShadows.value=z.state.directionalShadow,ze.spotLights.value=z.state.spot,ze.spotLightShadows.value=z.state.spotShadow,ze.rectAreaLights.value=z.state.rectArea,ze.ltc_1.value=z.state.rectAreaLTC1,ze.ltc_2.value=z.state.rectAreaLTC2,ze.pointLights.value=z.state.point,ze.pointLightShadows.value=z.state.pointShadow,ze.hemisphereLights.value=z.state.hemi,ze.directionalShadowMap.value=z.state.directionalShadowMap,ze.directionalShadowMatrix.value=z.state.directionalShadowMatrix,ze.spotShadowMap.value=z.state.spotShadowMap,ze.spotLightMatrix.value=z.state.spotLightMatrix,ze.spotLightMap.value=z.state.spotLightMap,ze.pointShadowMap.value=z.state.pointShadowMap,ze.pointShadowMatrix.value=z.state.pointShadowMatrix),V.currentProgram=We,V.uniformsList=null,We}function Hi(S){if(S.uniformsList===null){const U=S.currentProgram.getUniforms();S.uniformsList=Hs.seqWithValue(U.seq,S.uniforms)}return S.uniformsList}function jr(S,U){const k=Fe.get(S);k.outputColorSpace=U.outputColorSpace,k.batching=U.batching,k.batchingColor=U.batchingColor,k.instancing=U.instancing,k.instancingColor=U.instancingColor,k.instancingMorph=U.instancingMorph,k.skinning=U.skinning,k.morphTargets=U.morphTargets,k.morphNormals=U.morphNormals,k.morphColors=U.morphColors,k.morphTargetsCount=U.morphTargetsCount,k.numClippingPlanes=U.numClippingPlanes,k.numIntersection=U.numClipIntersection,k.vertexAlphas=U.vertexAlphas,k.vertexTangents=U.vertexTangents,k.toneMapping=U.toneMapping}function ia(S,U,k,V,z){U.isScene!==!0&&(U=Ye),Ue.resetTextureUnits();const ue=U.fog,_e=V.isMeshStandardMaterial?U.environment:null,Pe=D===null?A.outputColorSpace:D.isXRRenderTarget===!0?D.texture.colorSpace:fi,Le=(V.isMeshStandardMaterial?x:C).get(V.envMap||_e),Be=V.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,We=!!k.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),ze=!!k.morphAttributes.position,ut=!!k.morphAttributes.normal,Tt=!!k.morphAttributes.color;let At=ui;V.toneMapped&&(D===null||D.isXRRenderTarget===!0)&&(At=A.toneMapping);const Ht=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,dt=Ht!==void 0?Ht.length:0,Ne=Fe.get(V),Lt=p.state.lights;if($===!0&&(le===!0||S!==T)){const Xt=S===T&&V.id===G;ke.setState(V,S,Xt)}let ft=!1;V.version===Ne.__version?(Ne.needsLights&&Ne.lightsStateVersion!==Lt.state.version||Ne.outputColorSpace!==Pe||z.isBatchedMesh&&Ne.batching===!1||!z.isBatchedMesh&&Ne.batching===!0||z.isBatchedMesh&&Ne.batchingColor===!0&&z.colorTexture===null||z.isBatchedMesh&&Ne.batchingColor===!1&&z.colorTexture!==null||z.isInstancedMesh&&Ne.instancing===!1||!z.isInstancedMesh&&Ne.instancing===!0||z.isSkinnedMesh&&Ne.skinning===!1||!z.isSkinnedMesh&&Ne.skinning===!0||z.isInstancedMesh&&Ne.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&Ne.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&Ne.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&Ne.instancingMorph===!1&&z.morphTexture!==null||Ne.envMap!==Le||V.fog===!0&&Ne.fog!==ue||Ne.numClippingPlanes!==void 0&&(Ne.numClippingPlanes!==ke.numPlanes||Ne.numIntersection!==ke.numIntersection)||Ne.vertexAlphas!==Be||Ne.vertexTangents!==We||Ne.morphTargets!==ze||Ne.morphNormals!==ut||Ne.morphColors!==Tt||Ne.toneMapping!==At||Ne.morphTargetsCount!==dt)&&(ft=!0):(ft=!0,Ne.__version=V.version);let Jt=Ne.currentProgram;ft===!0&&(Jt=ki(V,U,z));let Nn=!1,Vt=!1,Qt=!1;const ht=Jt.getUniforms(),Gt=Ne.uniforms;if(ge.useProgram(Jt.program)&&(Nn=!0,Vt=!0,Qt=!0),V.id!==G&&(G=V.id,Vt=!0),Nn||T!==S){ht.setValue(w,"projectionMatrix",S.projectionMatrix),ht.setValue(w,"viewMatrix",S.matrixWorldInverse);const Xt=ht.map.cameraPosition;Xt!==void 0&&Xt.setValue(w,me.setFromMatrixPosition(S.matrixWorld)),Ae.logarithmicDepthBuffer&&ht.setValue(w,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&ht.setValue(w,"isOrthographic",S.isOrthographicCamera===!0),T!==S&&(T=S,Vt=!0,Qt=!0)}if(z.isSkinnedMesh){ht.setOptional(w,z,"bindMatrix"),ht.setOptional(w,z,"bindMatrixInverse");const Xt=z.skeleton;Xt&&(Xt.boneTexture===null&&Xt.computeBoneTexture(),ht.setValue(w,"boneTexture",Xt.boneTexture,Ue))}z.isBatchedMesh&&(ht.setOptional(w,z,"batchingTexture"),ht.setValue(w,"batchingTexture",z._matricesTexture,Ue),ht.setOptional(w,z,"batchingIdTexture"),ht.setValue(w,"batchingIdTexture",z._indirectTexture,Ue),ht.setOptional(w,z,"batchingColorTexture"),z._colorsTexture!==null&&ht.setValue(w,"batchingColorTexture",z._colorsTexture,Ue));const Wt=k.morphAttributes;if((Wt.position!==void 0||Wt.normal!==void 0||Wt.color!==void 0)&&it.update(z,k,Jt),(Vt||Ne.receiveShadow!==z.receiveShadow)&&(Ne.receiveShadow=z.receiveShadow,ht.setValue(w,"receiveShadow",z.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(Gt.envMap.value=Le,Gt.flipEnvMap.value=Le.isCubeTexture&&Le.isRenderTargetTexture===!1?-1:1),V.isMeshStandardMaterial&&V.envMap===null&&U.environment!==null&&(Gt.envMapIntensity.value=U.environmentIntensity),Vt&&(ht.setValue(w,"toneMappingExposure",A.toneMappingExposure),Ne.needsLights&&Jn(Gt,Qt),ue&&V.fog===!0&&De.refreshFogUniforms(Gt,ue),De.refreshMaterialUniforms(Gt,V,ae,Z,p.state.transmissionRenderTarget[S.id]),Hs.upload(w,Hi(Ne),Gt,Ue)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(Hs.upload(w,Hi(Ne),Gt,Ue),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&ht.setValue(w,"center",z.center),ht.setValue(w,"modelViewMatrix",z.modelViewMatrix),ht.setValue(w,"normalMatrix",z.normalMatrix),ht.setValue(w,"modelMatrix",z.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){const Xt=V.uniformsGroups;for(let mi=0,un=Xt.length;mi<un;mi++){const Cn=Xt[mi];bt.update(Cn,Jt),bt.bind(Cn,Jt)}}return Jt}function Jn(S,U){S.ambientLightColor.needsUpdate=U,S.lightProbe.needsUpdate=U,S.directionalLights.needsUpdate=U,S.directionalLightShadows.needsUpdate=U,S.pointLights.needsUpdate=U,S.pointLightShadows.needsUpdate=U,S.spotLights.needsUpdate=U,S.spotLightShadows.needsUpdate=U,S.rectAreaLights.needsUpdate=U,S.hemisphereLights.needsUpdate=U}function kt(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return X},this.getActiveMipmapLevel=function(){return I},this.getRenderTarget=function(){return D},this.setRenderTargetTextures=function(S,U,k){Fe.get(S.texture).__webglTexture=U,Fe.get(S.depthTexture).__webglTexture=k;const V=Fe.get(S);V.__hasExternalTextures=!0,V.__autoAllocateDepthBuffer=k===void 0,V.__autoAllocateDepthBuffer||Ie.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),V.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(S,U){const k=Fe.get(S);k.__webglFramebuffer=U,k.__useDefaultFramebuffer=U===void 0},this.setRenderTarget=function(S,U=0,k=0){D=S,X=U,I=k;let V=!0,z=null,ue=!1,_e=!1;if(S){const Le=Fe.get(S);Le.__useDefaultFramebuffer!==void 0?(ge.bindFramebuffer(w.FRAMEBUFFER,null),V=!1):Le.__webglFramebuffer===void 0?Ue.setupRenderTarget(S):Le.__hasExternalTextures&&Ue.rebindTextures(S,Fe.get(S.texture).__webglTexture,Fe.get(S.depthTexture).__webglTexture);const Be=S.texture;(Be.isData3DTexture||Be.isDataArrayTexture||Be.isCompressedArrayTexture)&&(_e=!0);const We=Fe.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(We[U])?z=We[U][k]:z=We[U],ue=!0):S.samples>0&&Ue.useMultisampledRTT(S)===!1?z=Fe.get(S).__webglMultisampledFramebuffer:Array.isArray(We)?z=We[k]:z=We,b.copy(S.viewport),N.copy(S.scissor),K=S.scissorTest}else b.copy(Ee).multiplyScalar(ae).floor(),N.copy(Te).multiplyScalar(ae).floor(),K=He;if(ge.bindFramebuffer(w.FRAMEBUFFER,z)&&V&&ge.drawBuffers(S,z),ge.viewport(b),ge.scissor(N),ge.setScissorTest(K),ue){const Le=Fe.get(S.texture);w.framebufferTexture2D(w.FRAMEBUFFER,w.COLOR_ATTACHMENT0,w.TEXTURE_CUBE_MAP_POSITIVE_X+U,Le.__webglTexture,k)}else if(_e){const Le=Fe.get(S.texture),Be=U||0;w.framebufferTextureLayer(w.FRAMEBUFFER,w.COLOR_ATTACHMENT0,Le.__webglTexture,k||0,Be)}G=-1},this.readRenderTargetPixels=function(S,U,k,V,z,ue,_e){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Pe=Fe.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&_e!==void 0&&(Pe=Pe[_e]),Pe){ge.bindFramebuffer(w.FRAMEBUFFER,Pe);try{const Le=S.texture,Be=Le.format,We=Le.type;if(!Ae.textureFormatReadable(Be)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ae.textureTypeReadable(We)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=S.width-V&&k>=0&&k<=S.height-z&&w.readPixels(U,k,V,z,je.convert(Be),je.convert(We),ue)}finally{const Le=D!==null?Fe.get(D).__webglFramebuffer:null;ge.bindFramebuffer(w.FRAMEBUFFER,Le)}}},this.readRenderTargetPixelsAsync=async function(S,U,k,V,z,ue,_e){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Pe=Fe.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&_e!==void 0&&(Pe=Pe[_e]),Pe){ge.bindFramebuffer(w.FRAMEBUFFER,Pe);try{const Le=S.texture,Be=Le.format,We=Le.type;if(!Ae.textureFormatReadable(Be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ae.textureTypeReadable(We))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(U>=0&&U<=S.width-V&&k>=0&&k<=S.height-z){const ze=w.createBuffer();w.bindBuffer(w.PIXEL_PACK_BUFFER,ze),w.bufferData(w.PIXEL_PACK_BUFFER,ue.byteLength,w.STREAM_READ),w.readPixels(U,k,V,z,je.convert(Be),je.convert(We),0),w.flush();const ut=w.fenceSync(w.SYNC_GPU_COMMANDS_COMPLETE,0);await Nf(w,ut,4);try{w.bindBuffer(w.PIXEL_PACK_BUFFER,ze),w.getBufferSubData(w.PIXEL_PACK_BUFFER,0,ue)}finally{w.deleteBuffer(ze),w.deleteSync(ut)}return ue}}finally{const Le=D!==null?Fe.get(D).__webglFramebuffer:null;ge.bindFramebuffer(w.FRAMEBUFFER,Le)}}},this.copyFramebufferToTexture=function(S,U=null,k=0){S.isTexture!==!0&&(console.warn("WebGLRenderer: copyFramebufferToTexture function signature has changed."),U=arguments[0]||null,S=arguments[1]);const V=Math.pow(2,-k),z=Math.floor(S.image.width*V),ue=Math.floor(S.image.height*V),_e=U!==null?U.x:0,Pe=U!==null?U.y:0;Ue.setTexture2D(S,0),w.copyTexSubImage2D(w.TEXTURE_2D,k,0,0,_e,Pe,z,ue),ge.unbindTexture()},this.copyTextureToTexture=function(S,U,k=null,V=null,z=0){S.isTexture!==!0&&(console.warn("WebGLRenderer: copyTextureToTexture function signature has changed."),V=arguments[0]||null,S=arguments[1],U=arguments[2],z=arguments[3]||0,k=null);let ue,_e,Pe,Le,Be,We;k!==null?(ue=k.max.x-k.min.x,_e=k.max.y-k.min.y,Pe=k.min.x,Le=k.min.y):(ue=S.image.width,_e=S.image.height,Pe=0,Le=0),V!==null?(Be=V.x,We=V.y):(Be=0,We=0);const ze=je.convert(U.format),ut=je.convert(U.type);Ue.setTexture2D(U,0),w.pixelStorei(w.UNPACK_FLIP_Y_WEBGL,U.flipY),w.pixelStorei(w.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),w.pixelStorei(w.UNPACK_ALIGNMENT,U.unpackAlignment);const Tt=w.getParameter(w.UNPACK_ROW_LENGTH),At=w.getParameter(w.UNPACK_IMAGE_HEIGHT),Ht=w.getParameter(w.UNPACK_SKIP_PIXELS),dt=w.getParameter(w.UNPACK_SKIP_ROWS),Ne=w.getParameter(w.UNPACK_SKIP_IMAGES),Lt=S.isCompressedTexture?S.mipmaps[z]:S.image;w.pixelStorei(w.UNPACK_ROW_LENGTH,Lt.width),w.pixelStorei(w.UNPACK_IMAGE_HEIGHT,Lt.height),w.pixelStorei(w.UNPACK_SKIP_PIXELS,Pe),w.pixelStorei(w.UNPACK_SKIP_ROWS,Le),S.isDataTexture?w.texSubImage2D(w.TEXTURE_2D,z,Be,We,ue,_e,ze,ut,Lt.data):S.isCompressedTexture?w.compressedTexSubImage2D(w.TEXTURE_2D,z,Be,We,Lt.width,Lt.height,ze,Lt.data):w.texSubImage2D(w.TEXTURE_2D,z,Be,We,ue,_e,ze,ut,Lt),w.pixelStorei(w.UNPACK_ROW_LENGTH,Tt),w.pixelStorei(w.UNPACK_IMAGE_HEIGHT,At),w.pixelStorei(w.UNPACK_SKIP_PIXELS,Ht),w.pixelStorei(w.UNPACK_SKIP_ROWS,dt),w.pixelStorei(w.UNPACK_SKIP_IMAGES,Ne),z===0&&U.generateMipmaps&&w.generateMipmap(w.TEXTURE_2D),ge.unbindTexture()},this.copyTextureToTexture3D=function(S,U,k=null,V=null,z=0){S.isTexture!==!0&&(console.warn("WebGLRenderer: copyTextureToTexture3D function signature has changed."),k=arguments[0]||null,V=arguments[1]||null,S=arguments[2],U=arguments[3],z=arguments[4]||0);let ue,_e,Pe,Le,Be,We,ze,ut,Tt;const At=S.isCompressedTexture?S.mipmaps[z]:S.image;k!==null?(ue=k.max.x-k.min.x,_e=k.max.y-k.min.y,Pe=k.max.z-k.min.z,Le=k.min.x,Be=k.min.y,We=k.min.z):(ue=At.width,_e=At.height,Pe=At.depth,Le=0,Be=0,We=0),V!==null?(ze=V.x,ut=V.y,Tt=V.z):(ze=0,ut=0,Tt=0);const Ht=je.convert(U.format),dt=je.convert(U.type);let Ne;if(U.isData3DTexture)Ue.setTexture3D(U,0),Ne=w.TEXTURE_3D;else if(U.isDataArrayTexture||U.isCompressedArrayTexture)Ue.setTexture2DArray(U,0),Ne=w.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}w.pixelStorei(w.UNPACK_FLIP_Y_WEBGL,U.flipY),w.pixelStorei(w.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),w.pixelStorei(w.UNPACK_ALIGNMENT,U.unpackAlignment);const Lt=w.getParameter(w.UNPACK_ROW_LENGTH),ft=w.getParameter(w.UNPACK_IMAGE_HEIGHT),Jt=w.getParameter(w.UNPACK_SKIP_PIXELS),Nn=w.getParameter(w.UNPACK_SKIP_ROWS),Vt=w.getParameter(w.UNPACK_SKIP_IMAGES);w.pixelStorei(w.UNPACK_ROW_LENGTH,At.width),w.pixelStorei(w.UNPACK_IMAGE_HEIGHT,At.height),w.pixelStorei(w.UNPACK_SKIP_PIXELS,Le),w.pixelStorei(w.UNPACK_SKIP_ROWS,Be),w.pixelStorei(w.UNPACK_SKIP_IMAGES,We),S.isDataTexture||S.isData3DTexture?w.texSubImage3D(Ne,z,ze,ut,Tt,ue,_e,Pe,Ht,dt,At.data):U.isCompressedArrayTexture?w.compressedTexSubImage3D(Ne,z,ze,ut,Tt,ue,_e,Pe,Ht,At.data):w.texSubImage3D(Ne,z,ze,ut,Tt,ue,_e,Pe,Ht,dt,At),w.pixelStorei(w.UNPACK_ROW_LENGTH,Lt),w.pixelStorei(w.UNPACK_IMAGE_HEIGHT,ft),w.pixelStorei(w.UNPACK_SKIP_PIXELS,Jt),w.pixelStorei(w.UNPACK_SKIP_ROWS,Nn),w.pixelStorei(w.UNPACK_SKIP_IMAGES,Vt),z===0&&U.generateMipmaps&&w.generateMipmap(Ne),ge.unbindTexture()},this.initRenderTarget=function(S){Fe.get(S).__webglFramebuffer===void 0&&Ue.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?Ue.setTextureCube(S,0):S.isData3DTexture?Ue.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?Ue.setTexture2DArray(S,0):Ue.setTexture2D(S,0),ge.unbindTexture()},this.resetState=function(){X=0,I=0,D=null,ge.reset(),Qe.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Yn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===qo?"display-p3":"srgb",t.unpackColorSpace=vt.workingColorSpace===Js?"display-p3":"srgb"}}class Xv extends sn{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Kn,this.environmentIntensity=1,this.environmentRotation=new Kn,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(t.object.environmentIntensity=this.environmentIntensity),t.object.environmentRotation=this.environmentRotation.toArray(),t}}class Wu extends Xr{constructor(e){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new xt(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const au=new It,Bo=new Cu,Us=new Qs,Ns=new W;class qv extends sn{constructor(e=new Zn,t=new Wu){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=t,this.updateMorphTargets()}copy(e,t){return super.copy(e,t),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,t){const n=this.geometry,r=this.matrixWorld,a=e.params.Points.threshold,o=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),Us.copy(n.boundingSphere),Us.applyMatrix4(r),Us.radius+=a,e.ray.intersectsSphere(Us)===!1)return;au.copy(r).invert(),Bo.copy(e.ray).applyMatrix4(au);const l=a/((this.scale.x+this.scale.y+this.scale.z)/3),c=l*l,h=n.index,g=n.attributes.position;if(h!==null){const m=Math.max(0,o.start),v=Math.min(h.count,o.start+o.count);for(let M=m,E=v;M<E;M++){const p=h.getX(M);Ns.fromBufferAttribute(g,p),ou(Ns,p,c,r,e,t,this)}}else{const m=Math.max(0,o.start),v=Math.min(g.count,o.start+o.count);for(let M=m,E=v;M<E;M++)Ns.fromBufferAttribute(g,M),ou(Ns,M,c,r,e,t,this)}}updateMorphTargets(){const t=this.geometry.morphAttributes,n=Object.keys(t);if(n.length>0){const r=t[n[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let a=0,o=r.length;a<o;a++){const l=r[a].name||String(a);this.morphTargetInfluences.push(0),this.morphTargetDictionary[l]=a}}}}}function ou(i,e,t,n,r,a,o){const l=Bo.distanceSqToPoint(i);if(l<t){const c=new W;Bo.closestPointToPoint(i,c),c.applyMatrix4(n);const h=r.ray.origin.distanceTo(c);if(h<r.near||h>r.far)return;a.push({distance:h,distanceToRay:Math.sqrt(l),point:c,index:e,face:null,object:o})}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:zo}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=zo);const Yv=document.querySelector("canvas.webgl"),$o=new Xv,na=500,$v=.03,lu=.5,Or=new Float32Array(na*3),Vs=new Float32Array(na*3);for(let i=0;i<na;i++)Or[i*3+0]=(Math.random()-.5)*10,Or[i*3+1]=(Math.random()-.5)*10,Or[i*3+2]=(Math.random()-.5)*10,Vs[i*3+0]=Math.random()*.5+.5,Vs[i*3+1]=Math.random()*.5+.5,Vs[i*3+2]=Math.random()*.5+.5;const Br=new Zn;Br.setAttribute("position",new xn(Or,3));Br.setAttribute("color",new xn(Vs,3));const jv=new Wu({size:$v,sizeAttenuation:!0,vertexColors:!0,transparent:!0,opacity:.8}),Kv=new qv(Br,jv);$o.add(Kv);const cu=Or.slice(),_n={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{_n.width=window.innerWidth,_n.height=window.innerHeight,zr.aspect=_n.width/_n.height,zr.updateProjectionMatrix(),kr.setSize(_n.width,_n.height),kr.setPixelRatio(Math.min(window.devicePixelRatio,2))});const zr=new gn(75,_n.width/_n.height,.1,100);zr.position.z=5;$o.add(zr);const kr=new Wv({canvas:Yv,alpha:!0});kr.setSize(_n.width,_n.height);kr.setPixelRatio(Math.min(window.devicePixelRatio,2));const js={x:0,y:0};window.addEventListener("mousemove",i=>{js.x=(i.clientX/_n.width-.5)*lu,js.y=(i.clientY/_n.height-.5)*lu});const Xu=()=>{const i=Br.attributes.position.array;for(let e=0;e<na;e++)i[e*3+0]=cu[e*3+0]+js.x,i[e*3+1]=cu[e*3+1]+js.y;Br.attributes.position.needsUpdate=!0,kr.render($o,zr),window.requestAnimationFrame(Xu)};Xu()});export default Zv();
//# sourceMappingURL=background-7UscaQjt.js.map
